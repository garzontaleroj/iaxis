...
<%/*
*  Fichero: axisfiscales_adquiriente001.jsp
*
*  @author 
*
*
  ...
  <head>
    ...
    <script language="Javascript" type="text/javascript">
        ...
        function f_but_cancelar() {
            ...
            parent.f_cerrar_axisfiscales_adquiriente001();
        }        
        
        function f_but_buscar() {
            //Si la validación es correcta, ejecutamos la acción
            objUtiles.ejecutarFormulario("modal_axisfiscales_adquiriente001.do", "form", document.miForm, "_self", objJsMessages.jslit_cargando);
        }
        
        function f_seleccionar (CODIGO, TEXTO){
                //Crear este método en el padre
                parent.f_aceptar_axisfiscales_adquiriente001(CODIGO, TEXTO);
        }
    ...
    <body class=" " onload="f_onload()" onkeypress="if (event.keyCode==13)  { f_but_buscar() }">
        ...
        <form name="miForm" action="" method="POST">
            ...
            <c:import url="../include/titulo_nt.jsp">
                <c:param name="formulario">axisfiscales_adquiriente001</c:param>
                <c:param name="producto">axisfiscales_adquiriente001</c:param>
                <c:param name="form">axisfiscales_adquiriente001</c:param>
            </c:import>
            <!-- Area de campos  -->
            <table id="tabla1" class="mainModalDimensions base" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        ...
                        <table class="seccion">
                            ...
                            <tr>
                                <td align="right" class="titulocaja">
                                    <b><axis:alt f="axisfiscales_adquiriente001" c="DESC" lit="100588"/></b>
                                </td>
                                <td align="left" class="campocaja">
                                    <input onBlur="javascript:f_but_buscar()" type="text" class="campowidthinput campo campotexto_ob" value="${__formdata.DESC}" name="DESC" id="DESC" size="15"
                                     style="width:90%" title="<axis:alt f="axisfiscales_adquiriente001" c="DESC" lit="100588"/>"/>
                                </td>
                            </tr>
                        </table>
                        ...
                        <!-- DisplayTag Agentes -->
                        <c:set var="title0"><axis:alt f="axisfiscales_adquiriente001" c="CODIGO" lit="1000109"/></c:set>
                        <c:set var="title1"><axis:alt f="axisfiscales_adquiriente001" c="DESC" lit="100588"/></c:set>
                        <div class="seccion displayspaceModalGenerico">
                            <display:table name="${T_IAX_GETCONSULTA}" id="T_IAX_GETCONSULT" export="false" class="dsptgtable" pagesize="11" defaultsort="3" defaultorder="ascending" requestURI="modal_axisfiscales_adquiriente001.do?paginar=true" sort="list" cellpadding="0" cellspacing="0">
                                ...
                                <display:column title="" sortable="false" headerClass="headwidth5 sortable"  media="html" autolink="false" >    
                                    <div class="dspIcons"><input type="radio" id="seleccionaRegistro" name="seleccionaRegistro" value="${T_IAX_GETCONSULT.CFIS_ADQUIRIENT}/${T_IAX_GETCONSULT.TFIS_ADQUIRIENT}"/></div>
                                </display:column>
                                <display:column title="${title0}" sortable="true" sortProperty="CODIGO" headerClass="headwidth10 sortable"  media="html" autolink="false" >
                                    <div class="dspNumber"><a href='javascript:f_seleccionar("${T_IAX_GETCONSULT.CFIS_ADQUIRIENT}","${T_IAX_GETCONSULT.TFIS_ADQUIRIENT}")'>${T_IAX_GETCONSULT.CFIS_ADQUIRIENT}</a></div>
                                        <input type='hidden' id='${T_IAX_GETCONSULT.CFIS_ADQUIRIENT}' value='${T_IAX_GETCONSULT.CFIS_ADQUIRIENT}'/>
                                </display:column>
                                <display:column title="${title1}" sortable="true" sortProperty="TEXTO" headerClass="sortable"  media="html" autolink="false" >
                                    <div class="dspText">  <a href='javascript:f_seleccionar("${T_IAX_GETCONSULT.CFIS_ADQUIRIENT}","${T_IAX_GETCONSULT.TFIS_ADQUIRIENT}")'>${T_IAX_GETCONSULT.TFIS_ADQUIRIENT}</a></div>
                                </display:column>
            ...
            <c:import url="../include/botonera_nt.jsp">
                <c:param name="f">axisfiscales_adquiriente001</c:param>
