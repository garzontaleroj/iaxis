    ...
    <body class=" " onload="f_onload()">
        <form name="miForm" action="" method="POST">
            ...
            <c:import url="../include/titulo_nt.jsp">
                <c:param name="formulario"><axis:alt f="axissin004mod" c="TITULO" lit="1000232" /></c:param>
                <c:param name="producto"><axis:alt f="axissin004mod" c="TITULO" lit="1000232" /></c:param>
                    ...
                    <td>
                        <table class="seccion">
                            <tr>
                                <td>
                                    <!-- DisplayTag Recibos -->
                                    <c:set var="title0"><axis:alt f="axissin004mod" c="NRECIBO" lit="800636"/></c:set>
                                    <c:set var="title1"><axis:alt f="axissin004mod" c="FEFECTO" lit="100883"/></c:set>
                                    <c:set var="title2"><axis:alt f="axissin004mod" c="FVENCIM" lit="100885"/></c:set>
                                    <c:set var="title3"><axis:alt f="axissin004mod" c="ICONCEP" lit="100563"/></c:set>
                                    <c:set var="title4"><axis:alt f="axissin004mod" c="TTIPREC" lit="102302"/></c:set>
                                    <c:set var="title5"><axis:alt f="axissin004mod" c="TESTREC" lit="100874"/></c:set>
            ...
            <c:import url="../include/botonera_nt.jsp">
                <c:param name="f">axissin004mod</c:param>
