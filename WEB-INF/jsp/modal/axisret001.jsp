    ...
    <script language="Javascript" type="text/javascript">
        ...
        function f_but_aceptar(SSEGURO,SRECREN) {
            ...
            if (typeof hayChecked == 'boolean' && objUtiles.estaVacio(SSEGURO)) {
                ...
                if(!objUtiles.estaVacio(SSEGURO)){
                    ...
                    parent.f_aceptar_axisret001(SSEGURO,SRECREN);
        ...
        function f_but_buscar() {
         if (objValidador.validaEntrada())
           objUtiles.ejecutarFormulario("modal_axisret001.do", "buscar", document.miForm, "_self", objJsMessages.jslit_cargando);
        }
        function f_recargar(thiss) {
           if (thiss.value > 0) 
                if (objValidador.validaEntrada())
                    objUtiles.ejecutarFormulario("modal_axisret001.do", "form", document.miForm, "_self", objJsMessages.jslit_cargando);
        }
        
        function f_but_cancelar() {
            parent.f_cerrar_modal('axisret001');
            
        }
        
        /* **************************************************** FUNCIONES PANTALLA ************************************************ */

        function f_cambia_sucursal(obj){
            // bug 0025691
            if (obj.value != "null"){
                objAjax.invokeAsyncCGI("modal_axisret001.do", callbackAjaxSelectedSucursal, 
                    "operation=ajax_selected_sucursal&SUCURSAL="+document.miForm.SUCURSAL.value, this, objJsMessages.jslit_actualizando_registro);}
        }

        function callbackAjaxSelectedSucursal(ajaxResponseText) {
            // bug 0025691
            var adnsucCombo = document.miForm.ADNSUC;
            try {
               var doc=objAjax.domParse(ajaxResponseText);
                                    
                if(!objAppMensajes.existenErroresEnAplicacion(doc)){
                    if(objUtiles.existeObjetoXml(doc.getElementsByTagName("element")[0])){
                        objDom.borrarOpcionesDeCombo(adnsucCombo);
                        ...
                        for(var i = 0;i < doc.getElementsByTagName("element").length;i++){
                            ...
                            objDom.addOpcionACombo(CAGENTE, TAGENTE, adnsucCombo, i);
                        }
                    }else{
                        objDom.borrarOpcionesDeCombo (adnsucCombo);
                        objDom.addOpcionACombo("", " - " + objJsMessages.jslit_seleccionar + " - ", adnsucCombo, null);
                    }
                }
        ...
        //alert("en recarga de combos");
                ...
                objAjax.invokeAsyncCGI("modal_axisret001.do", callbackAjaxActualizarCombos, 
    ...
    <body onload="f_onload()" onkeypress="if (event.keyCode==13)  { f_but_buscar() }" >
        ...
        <form name="miForm" action="" method="POST">
            ...
            <c:import url="../include/titulo_nt.jsp">
                <c:param name="formulario"><axis:alt f="axisret001" c="LIT_FORMULARIO_1" lit="9904200" /></c:param>
                <c:param name="producto"><axis:alt f="axisret001" c="LIT_PANTALLA_1" lit="9904200" /></c:param>
                <c:param name="form">axisret001</c:param>
            </c:import>
            <c:import url="../include/modal_estandar.jsp">
                <c:param name="titulo"><axis:alt f="axisret001" c="TITULO_INC" lit="1000234"/></c:param>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table class="area" align="center">
                                        ...
                                        <tr>
                                           <axis:visible f="axisret001" c="CODCONV" >
                                                <td class="titulocaja">
                                                    <b><axis:alt f="axisret001" c="LIT_CCODIGO" lit="109155" /></b>
                                                </td>
                                             </axis:visible>	
                                           <axis:visible f="axisret001" c="TDESCONV" >
                                                <td class="titulocaja" colspan="3">
                                                    <b><axis:alt f="axisret001" c="LIT_TDESCRI" lit="100588" /></b>
                                                </td>
                                             </axis:visible>	
                                        </tr>
                                        <tr>
                                            <axis:visible f="axisret001" c="CODCONV">
                                                 <td class="campocaja"> 
                                                    <input style="width:85%" type="text" class="campowidthinput campo campotexto" id="CODCONV" name="CODCONV" size="15"
                                                    value ="${__formdata.CODCONV}" title="<axis:alt f="axisret001" c="ALT_CODCONV" lit="100885"/>" <axis:atr f="axisret001" c="CODCONV" a="modificable=true"/>/>
                                                </td>
                                            </axis:visible>
                                            <axis:visible f="axisret001" c="TDESCONV">
                                                 <td class="campocaja" colspan="3">
                                                    <input style="width:85%" type="text" class="campowidthinput campo campotexto" id="TDESCONV" name="TDESCONV" size="15"
                                                    value ="${__formdata.TDESCONV}" title="<axis:alt f="axisret001" c="ALT_TDESCONV" lit="100885"/>" <axis:atr f="axisret001" c="TDESCONV" a="modificable=true"/>/>
                                                 </td>
                                            </axis:visible>
                                        </tr>
                                        <tr>
                                           <axis:visible f="axisret001" c="FINIVIG" >
                                                <td class="titulocaja">
                                                    <b><axis:alt f="axisret001" c="LIT_FINIVIG" lit="9000716" /></b>
                                                </td>
                                             </axis:visible>	
                                           <axis:visible f="axisret001" c="FFINVIG" >
                                                <td class="titulocaja">
                                                    <b><axis:alt f="axisret001" c="LIT_FFINVIG" lit="9000717" /></b>
                                                </td>
                                             </axis:visible>	
                                        </tr>
                                        <tr>
                                            <axis:visible f="axisret001" c="FINIVIG">
                                                 <td class="campocaja">
                                                    ...
                                                    value ="<fmt:formatDate pattern="dd/MM/yyyy" value="${__formdata.FINIVIG}"/>" title="<axis:alt f="axisret001" c="x" lit="100885"/>" <axis:atr f="axisret001" c="FINIVIG" a="modificable=true&formato=fecha"/>/>
                                                    <a id="icon_FINIVIG" style="vertical-align:middle;" href="#">
                                                    <img border="0" alt="<axis:alt f="axisret001" c="ddd" lit="108341" />" title="<axis:alt f="axisret001" c="x1" lit="108341" />" src="images/calendar.gif"/>
                                                    </a>
                                                </td>
                                            </axis:visible>
                                            <axis:visible f="axisret001" c="FFINVIG">
                                                 <td class="campocaja">
                                                    ...
                                                    value ="<fmt:formatDate pattern="dd/MM/yyyy" value="${__formdata.FFINVIG}"/>" title="<axis:alt f="axisret001" c="x" lit="100885"/>" <axis:atr f="axisret001" c="FFINVIG" a="modificable=true&formato=fecha"/>/>
                                        ...
                                        <tr>
                                           <%--axis:visible f="axisret001" c="CEMPRES" >
                                                <td class="titulocaja">
                                                    <b><axis:alt f="axisret001" c="LIT_CEMPRES" lit="101619" /></b>
                                                </td>
                                             </axis:visible--%>	
                                           <axis:visible f="axisret001" c="CRAMO" >
                                                <td class="titulocaja">
                                                    <b><axis:alt f="axisret001" c="LIT_CRAMO" lit="100784" /></b>
                                                </td>
                                             </axis:visible>	
                                           <axis:visible f="axisret001" c="SPRODUC" >
                                                <td class="titulocaja">
                                                    <b><axis:alt f="axisret001" c="LIT_SPRODUC" lit="100829" /></b>
                                                </td>
                                             </axis:visible>	
                                        ...
                                        <%--axis:ocultar f="axisadm054" c="CEMPRES"> 
                                            <c:choose>  
                                                <c:when test="${fn:length(__formdata.listValores.lstempresas) > 1 && !empty __formdata.listValores.lstempresas}">
                                                  <td class="campocaja">
                                                        ...
                                                        title="<axis:alt f="axisret001" c="LIT_SEL_CEMPRES" lit="101619" />" onchange="f_recarga_combos('E');"
                                                        <axis:atr f="axisret001" c="CEMPRES" a="isInputText=false&obligatorio=false"/>>
                                                            <option value="<%=Integer.MIN_VALUE%>"> - <axis:alt f="axisret001" c="LIT_SELEC_CEMPRES" lit="108341" /> - </option>                                                                                                        
                                            ...
                                            <c:otherwise> 
                                                 ...
                                                 <axis:atr f="axisret001" c="CEMPRES" a="modificable=false&obligatorio=true"/>/>
                                    ...
                                    <axis:ocultar f="axisret001" c="CRAMO"> 
                                     <td class="campocaja">
                                                    <select name="CRAMO" id ="CRAMO" size="1" class="campo campotexto" style="width:90%" 
                                                    title="<axis:alt f="axisret001" c="LIT_TIT_CRAMO" lit="100784" />" onchange="f_recarga_combos('R');"
                                                    <axis:atr f="axisret001" c="CRAMO" a="isInputText=false"/>>
                                                        <option value="<%= Integer.MIN_VALUE %>"> - <axis:alt f="axisret001" c="LIT_SEL_CRAMO" lit="108341" /> - </option>
                                    ...
                                    <axis:ocultar f="axisret001" c="SPRODUC"> 
                                      <td class="campocaja" colspan="1">
                                                    <select name="SPRODUC" id ="SPRODUC" size="1" class="campo campotexto" style="width:95%"
                                                    title="<axis:alt f="axisret001" c="LIT_TIT_SPRODUC" lit="100829" />" <axis:atr f="axisadm054" c="SPRODUC" a="isInputText=false"/>>
                                                        <option value="<%= Integer.MIN_VALUE %>"> - <axis:alt f="axisret001" c="LIT_SEL_SPRODUC" lit="108341" /> - </option>
                                   ...
                                   <!-- ****************************************************** SECCION INTERMEDIARIO ******************************************************* -->
                                   <tr>
                                        <td class="titulocaja">
                                            <b><axis:alt f="axisret001" c="CAGENTE_TEXT" lit="9902363"/></b> <%-- Intermediario --%>
                                        </td>
                                        <td class="titulocaja" colspan="2">
                                            <b><axis:alt f="axisret001" c="NOMBRE_TEXT" lit="100588"/>&nbsp;<axis:alt f="axisret001" c="INTERMED_D" lit="9902363"/></b> <%-- Descripción Intermediario--%>
                                        </td>       
                                             <!-- bug 0025691 -->
                                             <axis:ocultar f="axisret001" c="SUCURSAL" dejarHueco="false">   
                                             <td  class = "titulocaja">
                                               <b><axis:alt f="axisret001" c="SUCURSAL" lit="9002202" /></b>
                                             </td>
                                             </axis:ocultar>
                                             <axis:ocultar f="axisret001" c="ADNSUC" dejarHueco="false">   
                                             <td  class = "titulocaja">
                                               <b><axis:alt f="axisret001" c="ADNSUC" lit="9902313" /></b>
                                             </td>
                                             </axis:ocultar> 
                                    </tr>
                                    <tr>
                                        <td class="campocaja">                 
                                            <input type="text" name="CAGENTE_TEXT" id="CAGENTE_TEXT" style="width:65%;" value="${__formdata.CODI}" class="campowidthinput campo campotexto" 
                                                    <axis:atr f="axisret001" c="CAGENTE" a="modificable=true"/> onchange="f_actualizar_agente()" />
                                        ...
                                        <td class="campocaja" colspan="2">                             
                                             ...
                                             <!-- bug 0025691 onchange f_cambia_sucursal(this) -->
                                             <axis:ocultar f="axisret001" c="SUCURSAL" dejarHueco="false">   
                                             <td>
                                               <select name= "SUCURSAL" id ="SUCURSAL" size="1" onchange="" class="campo campotexto" style="width:70%"
                                                  title="<axis:alt f="axisret001" c="SUCURSAL" lit="9002202"/>">
                                                    <option value="<%=Integer.MIN_VALUE%>"> - <axis:alt f="axisret001" c="SELECTED" lit="1000348"/> - </option>
                                             ...
                                             <td>
                                               <select name= "ADNSUC" id ="ADNSUC" size="1" onchange="" class="campo campotexto" style="width:70%"
                                                  title="<axis:alt f="axisret001" c="ADNSUC" lit="9902313"/>">
                                                    <option value="<%=Integer.MIN_VALUE%>"> - <axis:alt f="axisret001" c="SELECTED" lit="1000348"/> - </option>
                                   ...
                                   <!-- ************************************************************************************************************************************ -->       
                                     <tr>
                                           <axis:visible f="axisret001" c="TNOMBNF" >
                                                <td class="titulocaja" colspan="4">
                                                    <b><axis:alt f="axisret001" c="LIT_TNOMBNF" lit="9903362" /></b>
                                                </td>
                                             </axis:visible>	
                                     </tr>
                                     <tr>
                                            ...
                                            <td class="campocaja" colspan="4">                             
                                             <input type="text" style="width:50%;" name="TNOMBNF" id="TNOMBNF" value="${__formdata.TNOMBNF}" class="campowidthinput campo campotexto"/>
                                            </axis:visible>
                                        </td>
                                     </tr>
...
<div class="separador">&nbsp;</div>                       
                  ...
                  <div class="titulo">
                    <img src="images/flecha.gif"/><axis:alt f="axisret002" c="LIT_IMG_1" lit="1000345" />
                  </div>      
                  <table class="seccion">
                             <!-- titulo -->
                                    <tr>
                            ...
                            <td align="left">
                                 <table border="0" class="area" align="left" style="width:100%;">
                                    ...
                                    <tr>
                                        <td>
                                            <c:set var="title0"><axis:alt f="axisret001" c="LISTA_CODIGO" lit="109155"/></c:set>
                                            <c:set var="title1"><axis:alt f="axisret001" c="LISTA_TDESCRI" lit="100588"/></c:set>
                                            <c:set var="title2"><axis:alt f="axisret001" c="LISTA_FINIVIG" lit="9000716"/></c:set>
                                            <c:set var="title3"><axis:alt f="axisret001" c="LISTA_FFINVIG" lit="9000717"/></c:set>
                                            <c:set var="title4"><axis:alt f="axisret001" c="EDITAR" lit="9901356"/></c:set>
                            
                                           

                                            <div class="seccion displayspaceGrande">
                                            <display:table name="${lista_convenios}" id="miListaId" export="false" class="dsptgtable" pagesize="8" defaultsort="1" defaultorder="ascending" requestURI="modal_axisret001.do?paginar=true"
                                            sort="list" cellpadding="0" cellspacing="0">
                                                ...
                                                <display:column title="${title0}" headerClass="sortable" sortProperty="CCODCONV"  media="html" autolink="false" >
                                                    <div class="dspText">${miListaId.CCODCONV}</div>
                                                </display:column>
                                                <display:column title="${title1}" headerClass="sortable" sortProperty="TDESCONV"  media="html" autolink="false" >
                                                    <div class="dspText">${miListaId.TDESCONV}</div>
                                                </display:column>
                                                <display:column title="${title2}" headerClass="sortable" sortProperty="FINIVIG"  media="html" autolink="false" >
                                                    <div class="dspText"><fmt:formatDate pattern="dd/MM/yyyy" value="${miListaId.FINIVIG}"/></div>    
                                                </display:column>
                                                <display:column title="${title3}" headerClass="sortable" sortProperty="FFINVIG"  media="html" autolink="false" >
                                                    <div class="dspText"><fmt:formatDate pattern="dd/MM/yyyy" value="${miListaId.FFINVIG}"/></div>    
                                                </display:column>
                                                
                                                <display:column title="${title4}" headerClass="sortable" sortProperty="TNOMTOM"  media="html" autolink="false" >
                                                    <div class="dspIcons">
                                                        <img border="0"
                                                            alt='<axis:alt f="axisret001" c="MENS_ALT" lit="9001944"/>'
                                                            title1='<axis:alt f="axisret001" c="MENS_ALT" lit="9001944"/>'
                                                            src="images/lapiz.gif"
                                                            width="16px" height="16px"
                                                            style="cursor:pointer;"
                                                            onclick="f_editar_convenio('${miListaId.IDCONVENIO}')"/>
                                                    </div>
                                                </display:column>
                                             </display:table> 
                                            </div>	
            ...
            <div class="separador">&nbsp;</div>
            <c:import url="../include/botonera_nt.jsp"><c:param name="f">axisret001</c:param><c:param name="f">axisret001</c:param>
                <c:param name="f">axisret001</c:param>
