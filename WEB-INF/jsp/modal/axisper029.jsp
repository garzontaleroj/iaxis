    ...
    <script language="Javascript" type="text/javascript">
        ...
        function f_onload() {
            ...
            if (!objUtiles.estaVacio(grabarOK) && grabarOK == "ok"){
                ...
                parent.f_aceptar_axisper029("${__formdata.SPERSON}");
            }
        ...
        function f_but_aceptar() {
            if (objValidador.validaEntrada()) {
                objUtiles.ejecutarFormulario("modal_axisper029.do", "guardar", document.miForm, "_self", objJsMessages.jslit_cargando);   
            }
        }
        function f_but_cancelar() {
            parent.f_cerrar_axisper029();
        }        
    ...
    <body onload="f_onload()">
        ...
        <form name="miForm" action="" method="POST">
            ...
            <c:import url="../include/titulo_nt.jsp">
                <c:param name="formulario"><axis:alt f="axisper029" c="formulario" lit="9903261" /></c:param>
                <c:param name="producto"><axis:alt f="axisper029" c="producto" lit="9903261" /></c:param>
                <c:param name="form">axisper029</c:param>
            </c:import>
                    ...
                    <td>
                        <table class="seccion">
                            ...
                            <tr>
                                <td>
                                    <div class="titulo">
                                        <b><axis:alt f="axisper029" c="LIT10" lit="9903259"/></b>
                                    </div>
                                    <div class="separador">&nbsp;</div>
                                        <c:set var="title1"> <axis:alt f="axisper029" c="CMODCON" lit="1000109"/></c:set>
                                              <c:set var="title2"><axis:alt f="axisper029" c="TTIPCON" lit="1000616"/> </c:set>
                                              <c:set var="title3"><axis:alt f="axisper029" c="TVALCON" lit="1000617"/> </c:set>
                                              <c:set var="title8"><axis:alt f="axisper029" c="CUSUMOD" lit="9903220"/></c:set>
                                              <c:set var="title9"><axis:alt f="axisper029" c="FBAJA" lit="9000447"/></c:set>
                                              <c:set var="title10"><axis:alt f="axisper029" c="FUSUMOD" lit="9903221"/></c:set>
                                              
                                              <div class="displayspace">
                                                <display:table name="${__formdata.CONTACTO}" id="AUTORIZACION" export="false" class="dsptgtable"
                                                            pagesize="-1" defaultsort="1" defaultorder="ascending" sort="list" cellpadding="0" cellspacing="0"
                                                            requestURI="axis_axisper029.do?paginar=true&subpantalla=datosgenerales">
                                                    ...
                                                    <display:column title="${title1}" sortable="true" sortProperty="OB_IAX_CONTACTOS.CMODCON"
                                                        ...
                                                        <div class="dspText"> ${AUTORIZACION.CONTACTO.CMODCON}</div>
                                                    </display:column>
                                                    <display:column title="${title2}" sortable="true" sortProperty="OB_IAX_CONTACTOS.TTIPCON"
                                                        ...
                                                        <div class="dspText">${AUTORIZACION.CONTACTO.TTIPCON}</div>
                                                    </display:column>
                                                    <display:column title="${title3}" sortable="true" sortProperty="OB_IAX_CONTACTOS.TVALCON"
                                                        ...
                                                        <div class="dspText">${AUTORIZACION.CONTACTO.TVALCON}</div>
                                                    </display:column>
                                    ...
                                    <table class="area" align="center">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="titulocaja">
                                                    <b><axis:alt f="axisper029" c="CESTADO" lit="100587"/></b>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <select name="CESTADO" id="CESTADO" size="1" class="campowidthselect campo campotexto" style="width:90%;"
                                                    title="<axis:alt f="axisper029" c="CESTADO" lit="100587"/>" 
                                                    ...
                                                    <c:if test="${ __formdata.MODO == 'MODIF'}">disabled="disabled"</c:if>>&nbsp;
                                                        <option value="<%= Integer.MIN_VALUE %>"> - <axis:alt f="axisper029" c="BLANCO" lit="1000348"/> - </option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="separador">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                                                <div class="titulocaja">
                                                    <b><axis:alt f="axisper029" c="TOBSERVA" lit="101162"/></b>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3">
                                                <input type="text" class="campowidthinput campo campotexto" size="15" value="${__formdata.TOBSERVA}" name="TOBSERVA" id="TOBSERVA" style="width:90%;"
                                                    title="<axis:alt f="axisper029" c="TOBSERVA" lit="101162"/>" <axis:atr f="axisper029" c="TOBSERVA" a="obligatorio=false"/> maxlength="200"
                                                    <c:if test="${ __formdata.MODO == 'MODIF'}">disabled="disabled"</c:if>/>
                                            </td>
                                        </tr>
                                        <div class="separador">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                                        <tr>
                                            <td>
                                                <div class="separador">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                                                <div class="titulocaja">
                                                    <b><axis:alt f="axisper029" c="CUSUAUT" lit="9903255"/></b>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="separador">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                                                <div class="titulocaja">
                                                    <b><axis:alt f="axisper029" c="FAUTORIZ" lit="9903221"/></b>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <input type="text" class="campowidthinput campo campotexto" size="15" value="${__formdata.CUSUAUT}" name="CUSUAUT" id="CUSUAUT" style="width:90%;"
                                                    title="<axis:alt f="axisper029" c="CUSUAUT" lit="9903255"/>" <axis:atr f="axisper011" c="CUSUAUT" a="obligatorio=false&modificable=false"/>/>
                                            </td>
                                            <td>
                                                <input type="text" class="campowidthinput campo campotexto" size="15" value="<fmt:formatDate pattern="dd/MM/yyyy" value="${__formdata.FAUTORIZ}"/>" name="FAUTORIZ" id="FAUTORIZ" style="width:50%;"
                                                    title="<axis:alt f="axisper029" c="FAUTORIZ" lit="9903221"/>" <axis:atr f="axisper011" c="FAUTORIZ" a="obligatorio=false&modificable=false"/>/>
                                            </td>
                                        </tr>
                                    </table>
                                    <div class="separador">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
            ...
            <c:import url="../include/botonera_nt.jsp"><c:param name="f">axisper029</c:param><c:param name="f">axisper029</c:param>
