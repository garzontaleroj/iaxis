...
<html>
<head>
    <title><axis:alt f="axissin062" c="TITULO" lit="151090"/></title>
    ...
    <script type="text/javascript">
        ...
        function f_cerrar_axisimprimir(){
			...
			var NSINIES = "${__formdata.NSINIES}";
			parent.f_aceptar_axissin062(NSINIES);
        }
        
        function f_aceptar_axissin062(NSINIES, PANTALLA, SECCION) {
            //alert("Aceptando la reserva");
            
            objUtiles.cerrarModal("axissin010");
			//objUtiles.ejecutarFormulario ("modal_axissin062.do", "form", document.miForm, "_self", objJsMessages.jslit_cargando);   
        ...
        function f_but_9907322(){
            if (objValidador.validaEntrada()) {
                objUtiles.ejecutarFormulario ("modal_axissin062.do", "genera_docupendiente", document.miForm, "_self", objJsMessages.jslit_cargando);   
            }
        }
        
        function f_but_cancelar(){
            parent.f_cerrar_modal("axissin062");
        }
        ...
        function f_getTramitacion(indexNou, NTRAMIT){
			if (document.miForm.indexTramitacio.value != indexNou){
				...
				objUtiles.ejecutarFormulario ("modal_axissin062.do", "recargar", document.miForm, "_self", objJsMessages.jslit_cargando);   
            }
        }
    </script>
</head>
<body onload="javascript:f_onload()">
	...
	<c:import url="../include/modal_estandar.jsp">
		<c:param name="nid_y_titulo">axisimprimir|<axis:alt f="axissin062" c="MODAL_IMPRIMIR" lit="1000205" /></c:param>
	</c:import>  
	<!-- AXISSIN010 ALTA RESERVA  -->
	<c:import url="../include/modal_estandar.jsp">
		<c:param name="nid_y_titulo">axissin010|<axis:alt f="axissin062" c="MODAL_AXISSIN010" lit="9000982"/></c:param>
	</c:import>
    <form name="miForm" action="modal_axissin062.do" method="POST">
    ...
    <c:import url="../include/titulo_nt.jsp">
        <c:param name="titulo"><axis:alt f="axissin062" c="TITULO_FORM" lit="9907321"/></c:param>
        <c:param name="formulario"><axis:alt f="axissin062" c="TITULO_FORM" lit="9907321"/></c:param>
        <c:param name="form">axissin062</c:param>
    </c:import>
		...
		<tr>
			<td><!-- CAMPOS HIDDEN EN PANTALLA -->
				...
				<table class="seccion">
					...
					<tr>
						<td class="titulocaja">
						  <b><axis:alt f="axissin062" c="LISTA_DOCUMENTOS" lit="9907321"/></b><!-- Estat actual -->
						</td>
                   ...
                   <tr>
                    <td colspan="22" style="width:100%;"  class="campocaja"> 
                                 <axis:visible f="axissin062" c="LISTA_DOCUMENTOS">
                                     <textarea class="campodisabled campo campotexto" title=title="<axis:alt f="axissin062" c="LISTA_DOCUMENTOS" lit="9907321"/>" <axis:atr f="axissin062" c="LISTA_DOCUMENTOS" a="modificable=true&isInputText=false&obligatorio=true"/> 
    ...
    <c:import url="../include/botonera_nt.jsp"><c:param name="f">axissin062</c:param><c:param name="__botones">cancelar,9907322</c:param></c:import>
    </form>
