...
<html>
    ...
    <!--*********************************** -->
        ...
        <script type="text/javascript">
            ...
            function f_but_aceptar () {
                objUtiles.ejecutarFormulario("modal_axisctr063.do?NPOLI="+document.miForm.NPOLIZA.value, "aceptar", document.miForm, "_self", objJsMessages.jslit_cargando);
            ...
            function f_canviestado (cvalor) {
            
                objUtiles.ejecutarFormulario("modal_axisctr063.do?CVALOR="+cvalor, "estado", document.miForm, "_self", objJsMessages.jslit_cargando);

            } 
             function f_but_cancelar() {
                        objAjax.invokeAsyncCGI("modal_axisctr063.do", callbackAjaxCancelar, "operation=ajax_cancelar", this, objJsMessages.jslit_cargando);
                    }
    ...
    <form name="miForm" action="axis_axisctr063.do" method="POST">
          ...
          <input type="hidden" id="CUSUALT" name="CUSUALT" value="${__formdata.CUSUALT}"/>
            ...
            <c:import url="../include/titulo_nt.jsp"> 
                ...
                <c:param name="form">axisctr063</c:param>
            </c:import>
        ...
        <tr>
            <td>
                ...
                <c:if test="${__formdata.PMODO == 1}"><fmt:message key="9001221" />
                    <c:if test="${!empty __formdata.NPOLIZA}"><fmt:message key="100624" />&nbsp;:&nbsp;${__formdata.NPOLIZA}</c:if><c:if test="${!empty __formdata.NCERTIF}">-${__formdata.NCERTIF}</c:if>
            ...
            <td>
                <table class="area" align="center">
                   <tr>
                    ...
                    <axis:ocultar f="axisctr063" c="NPOLIZA" dejarHueco="false">
                    <tr>
                        <!-- Titulo N.Poliza -->
                        <td class="titulocaja">
                    ...
                    <tr>
                        ...
                        <td class="campocaja">
                            ...
                            style="width:55%;" 
                            title="<fmt:message key="100624"/>" <axis:atr f="axisctr063" c="NPOLIZA" a="formato=entero&modificable=false"/>/>
                        </td> 
                        <%-- Bug 11177 NMM.i. <td class="campocaja">${__formdata} --%>
                        <!-- N.Certificat -->
                        <td class="campocaja">
                            <input type="text" class="campowidthinput campo campotexto"  size="30" value="${__formdata.NCERTIF}" name="NCERTIF" id="NCERTIF" 
                            style="width:55%;"
                            title="<fmt:message key="101300"/>" <axis:atr f="axisctr063" c="NCERTIF" a="formato=entero&modificable=false"/>/>
                        </td> 
                        <%-- Bug 11177 NMM.f. --%>
                     ...
                     <axis:ocultar f="axisctr063" c="TTITULO" dejarHueco="false">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="campocaja" colspan="2">
                            <input type="text" class="campowidthinput campo campotexto" size="30" value="${__formdata.TTITULO}" name="TTITULO" id="TTITULO" 
                            style="width:100%;" maxlength="100" title="<fmt:message key="9001196"/>" <axis:atr f="axisctr063" c="TTITULO" a="modificable=true&obligatorio=true"/>
                        </td> 
                    </tr>
                    </axis:ocultar>
                    <axis:ocultar f="axisctr063" c="TTEXTOS" dejarHueco="false">
                    <tr>
                        <!-- Titulo Texto Apunte -->
                        <td class="titulocaja">
                    ...
                    <tr>
                       ...
                       <%-- Cambio para IAXIS-16304 : start --%>                      
                          <textarea  rows="20" cols="50" class="campo campotexto" 
                          			 style="width:66%;overflow: scroll;" name="TTEXTOS" id="TTEXTOS" 
                           <axis:atr f="axisctr063" c="TTEXTOS" a="modificable=true"/>>${__formdata.TTEXTOS}</textarea>
                ...
                <table class="area" align="center">
                   ...
                   <tr>
                      <c:if test="${__formdata.PMODO == 1}">                                                   
                         ...
                         <axis:ocultar f="axisctr063" c="TESTADO" dejarHueco="false">
                         <td class="titulocaja">
                      ...
                      <axis:ocultar f="axisctr063" c="TTIPREG" dejarHueco="false">
                      <td class="titulocaja">
                   ...
                   <tr>
                      <c:if test="${__formdata.PMODO == 1}">                           
                      <!-- Estado Apunte -->
                         <axis:ocultar f="axisctr063" c="CESTADO" dejarHueco="false">
                         <td class="campocaja">
                            <select name = "CESTADO" id="CESTADO" style="width:75%;" <axis:atr f="axisctr063" c="CESTADO" a="modificable=true&obligatorio=true"/> size="1" onchange="f_canviestado(this.value)" class="campowidthselect campo campotexto" >
                               <option value = "<%= Integer.MIN_VALUE %>"> - <fmt:message key="1000348"/> - </option>
                               <c:forEach var="testado" items="${lstestadosapunteagenda}">
                      ...
                      <!-- Concepto Apunte -->                      
                         <axis:ocultar f="axisctr063" c="TTIPREG" dejarHueco="false">
                         <td class="campocaja">
                            <select name = "CTIPREG" id="CTIPREG" style="width:75%;" <axis:atr f="axisctr063" c="TTIPREG" a="modificable=true&obligatorio=true"/> size="1" onchange="" class="campowidthselect campo campotexto" >
                               <option value = "<%= Integer.MIN_VALUE %>"> - <fmt:message key="1000348"/> - </option>
                               <c:forEach var="ttipreg" items="${lstconceptosapunteagenda}">
                                  <option value = "${ttipreg.CATRIBU}"
                                     <c:if test="${ttipreg.CATRIBU == __formdata.CTIPREG}">selected</c:if>>
                                     ${ttipreg.TATRIBU}
                                  </option>
                               </c:forEach>
                            </select>
                     ...
                     <input type="hidden" class="campowidthinput campo campotexto" size="15" value="<fmt:formatDate value='${__formdata.FALTA}' pattern='dd/MM/yyyy'/>" name="FALTA" id="FALTA" 
                       ...
                       <tr>
                          ...
                          <td class="campocaja">
                             ...
                             <axis:atr f="axisctr063" c="FFINALI" a="modificable=true"/> />
                             <a style="vertical-align:middle;"><img
    ...
    <axis:visible f="axisctr063" c="FALTA">
    <script type="text/javascript">
        Calendar.setup({
            inputField     :    "FALTA",     
            ifFormat       :    "%d/%m/%Y",      
     ...
     <axis:visible f="axisctr063" c="FFINALI">
        <script type="text/javascript">
           Calendar.setup({
               inputField     :    "FFINALI",     
               ifFormat       :    "%d/%m/%Y",      
