...
<html>
  <head>
    ...
    function f_but_cancelar() {
        parent.f_cerrar_axislistaeditor()
    }
    function f_but_aceptar() {
        document.miForm.operation.value="modaleditoraceptar"
        document.miForm.submit()
    }
    function f_onload() {
        document.miForm.XMIDATO.focus()
        <c:if test="${!empty OK}">
...
<input type="hidden" name="thsid" value="${__formdata.thsid}" />
<%--c:import url="../include/titulo_estandar.jsp">
    <c:param name="formulario">${__formdata.CAMPO}@${__formdata.origen}:${__formdata.ID_REG}</c:param>
    <c:param name="form">axislistaeditor</c:param>
</c:import--%>
