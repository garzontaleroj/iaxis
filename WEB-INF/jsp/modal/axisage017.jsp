<%--
      NOMBRE:    axisage017.jsp
      @author <a href = "mailto:joan_torres@csi-ti.com">Joan Torres</a>
      Fecha: 24/10/2011
      PROPÓSITO (descripción pantalla):  Mantenimiento subvención
...
<html>
        ...
        <script type="text/javascript">
           ...
           function f_onload(){
               ...
               <c:if test="${resultadoOK=='OK'}" >
                    //alert("<axis:alt f='axisage017' c='ALERT' lit='1000405' />");
                    parent.f_cerrar_modal('axisage017');
               </c:if>
           }
           ...
           function f_but_aceptar() {
                if (objValidador.validaEntrada()){
                    ...
                    objUtiles.ejecutarFormulario("modal_axisage017.do", "aceptar", document.miForm, "_self", objJsMessages.jslit_cargando);
                }
           }  
           ...
           function f_cargar_productos(){
                ...
                objAjax.invokeAsyncCGI("modal_axisage017.do", callbackAjaxCargarProductos, url, this, objJsMessages.jslit_cargando);
            }   
            ...
            function callbackAjaxCargarProductos (ajaxResponseText){
                ...
                if(!objAppMensajes.existenErroresEnAplicacion(doc)){
                   ...
                   objDom.addOpcionACombo("<%= Integer.MIN_VALUE %>", '- <axis:alt f="axisage017" c="BLANCO" lit="108341"/> - ', SPRODUCCombo, 0);
           ...
           function f_cargar_actividades(){
                if (document.getElementById('CACTIVI')!=null){
                    ...
                    objAjax.invokeAsyncCGI("modal_axisage017.do", callbackAjaxCargarActividades, url, this, objJsMessages.jslit_cargando);
                }
            } 
            ...
            function callbackAjaxCargarActividades (ajaxResponseText){
                ...
                if(!objAppMensajes.existenErroresEnAplicacion(doc)){
                    ...
                    objDom.addOpcionACombo("<%= Integer.MIN_VALUE %>", '- <axis:alt f="axisage017" c="BLANCO" lit="108341"/> - ', CACTIVICombo, 0);
                       for (i = 0; i < elementos.length; i++) {
 ...
 <body class=" " onload="f_onload()" onkeypress="if (event.keyCode==13)  { f_but_buscar() }">
        ...
        <form name="miForm" action="" method="POST">
            ...
            <input type="hidden" id="EDIT" name="EDIT" value="${__formdata.EDIT}"/>
            
            <c:set var="modoEdit" value="${__formdata.EDICION}"/>
            
            <c:import url="../include/titulo_nt.jsp">
                <c:param name="formulario"><axis:alt c="LIT_FORM" f="axisage017" lit="9902557"/></c:param>
                <c:param name="producto"><axis:alt c="LIT_FORM" f="axisage017" lit="9902557"/></c:param>
                <c:param name="form">axisage017</c:param>
            </c:import>
            <!-- Area de campos  -->
                        ...
                        <table class="seccion">
                            ...
                            <tr>
                                <td class="campocaja" colspan="4">
                                    <div class="titulo">
                                        <img src="images/flecha.gif"/><axis:alt c="DSP_TITULO" f="axisage017" lit="9902557"/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <%-- Tipo agente --%>
                                <td class="titulocaja" >
                                    <b><axis:alt f="axisage017" c="CTIPAGE" lit="100584"/></b>
                                </td>
                            </tr>
                            <tr>
                                <%-- Código agente --%>
                                <td class="campocaja" colspan="3" >
                                    ...
                                    value="${__formdata.CAGENTE}" name="CAGENTE" id="CAGENTE" <axis:atr f="axisage017" c="CAGENTE"/>
                                    style="width:8%;" title="<axis:alt f="axisage017" c="CAGENTE" lit="9000531"/>" readonly="readonly" >                             

                                <%-- Código agente --%>
                                    <input type="text" class="campowidthinput campo campotexto" size="15" 
                                    value="${__formdata.TAGENTE}" name="TAGENTE" id="TAGENTE" 
                                    style="width:50%;" title="<axis:alt f="axisage017" c="TAGENTE" lit="100584"/>" readonly="readonly"/>
                                </td> 
                            </tr>
                            
                            <tr>
                                <axis:visible f="axisage017" c="CRAMO">
                                    <td class="titulocaja" >
                                        <b><axis:alt f="axisage017" c="CRAMO" lit="100784" /></b>
                                    </td>
                                </axis:visible>
                                <axis:visible f="axisage017" c="SPRODUC">
                                    <td class="titulocaja" >
                                        <b><axis:alt f="axisage017" c="SPRODUC" lit="100829" /></b>
                                    </td>
                                </axis:visible>
                                <axis:visible f="axisage017" c="CACTIVI">
                                    <td class="titulocaja">
                                        <b><axis:alt f="axisage017" c="CACTIVI" lit="103481" /></b>
                                    </td>
                                </axis:visible>
                                <axis:visible f="axisage017" c="IIMPORTE">
                                    <td class="titulocaja">
                                        <b><axis:alt f="axisage017" c="IIMPORTE" lit="100563"/>
                                    </td>
                                </axis:visible>
                            </tr> 
                            <tr>
                                <axis:visible f="axisage017" c="CRAMO">
                                    <td class="campocaja">
                                        <select name = "ramoProducto" id="ramoProducto"  size="1" onchange="f_cargar_productos()" class="campowidthselect campo" 
                                        <c:if test="${!modoEdit}">obligatorio="true"</c:if> <c:if test="${modoEdit}">readonly="true" disabled="true" obligatorio="false"</c:if> >
                                            <option value = "<%= Integer.MIN_VALUE %>"> - <axis:alt f="axisage017" c="BLANCO" lit="108341"/> - </option>
                                ...
                                <axis:visible f="axisage017" c="SPRODUC">
                                    <td class="campocaja" > 
                                        <select name = "SPRODUC" id ="SPRODUC" size="1" onchange="f_cargar_actividades()" class="campowidthselect campo campotexto"
                                                title="<axis:alt f='axisage017' c='SPRODUC' lit='100829'/>"
                                        <c:if test="${!modoEdit}">obligatorio="true"</c:if> <c:if test="${modoEdit}">readonly="true" disabled="true" obligatorio="false"</c:if> >
                                            <option value="<%= Integer.MIN_VALUE %>"> - <axis:alt f="axisage017" c="BLANCO" lit="108341" /> - </option>
                                ...
                                <td class="campocaja">
                                    <select name="CACTIVI" id ="CACTIVI" size="1" onchange="" class="campowidthselect campo campotexto" 
                                            title="<axis:alt f='axisage017' c='CACTIVI' lit='103481'/>"
                                    <c:if test="${!modoEdit}">obligatorio="true"</c:if> <c:if test="${modoEdit}">readonly="true" disabled="true" obligatorio="false"</c:if> >
                                        <option value="<%= Integer.MIN_VALUE %>"> - <axis:alt f="axisage017" c="BLANCO" lit="108341" /> - </option>
                                ...
                                <axis:visible f="axisage017" c="IIMPORTE">
                                    <td class="campocaja">
                                        ...
                                        title="<axis:alt c='IIMPORTE' f='axisage017' lit='100563'/>" style="width:50%;"
                                        <axis:atr f="axisage017" c="IIMPORTE" a="obligatorio=true&modificable=true&formato=decimal"/>
...
<c:import url="../include/botonera_nt.jsp">
           <c:param name="f">axisage017</c:param>
