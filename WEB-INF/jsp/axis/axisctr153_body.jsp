...
<c:choose>
    ...
    <c:otherwise>
        <c:set var="pantalla" value="axisctr153"/>
        <c:choose>
            <c:when test="${sessionScope.MODO eq 'SUPLEMENTO_238'}">
                <c:set var="literalPantalla" value="9900969"/>
            </c:when>
            <c:otherwise>
                <c:set var="literalPantalla" value="180435"/>
            </c:otherwise>
        </c:choose>
    </c:otherwise>
</c:choose>
...
<c:if test="${param.multiPantalla != 'true'}">        
    ...
    <c:if test="${__configform.axisctr153__CREVALI__visible == 'false'}">
    <input type="hidden" id="CREVALI" name="CREVALI" value="${sessionScope.axisctr_CREVALI}"/>
    </c:if>
    <c:if test="${__configform.axisctr153__PREVALI__visible == 'false'}">
    ...
    <table class="mainTableDimensions base" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <c:if test="${param.multiPantalla != 'true'}">        
                    <table class="seccion">
                        <tr>
                            ...
                            <font color="#FF8400" ><b>
                                <axis:visible c="ETIQ_RISC" f="axisctr153">
                                    <axis:alt f="axisctr153" c="ETIQ_RISC" lit="100649"></axis:alt> 
                                </axis:visible>
                ...
                <div class="titulo"><img src="images/flecha.gif"/><axis:alt f="axisctr153" c="DSP_GARANTIAS" lit="1000183" ></axis:alt></div>
                <!--campos-->
                <table class="seccion">
                    <tr>
                        <td>
                            ...
                            <c:if test="${! empty sessionScope.axisctr_garantias}">
                                ...
                                <div id="DSP_GARANTIAS" class="displayspaceOver" style="visibility:hidden;height:<c:out value="${num_gar*20+20+20}"/>px">&nbsp;</div>
                                    <div id="dt_garantias" class="displayspace" style="height:<c:out value="${num_gar*20+20+20}"/>px;max-height: ${num_gar*20+20+20}px;">   
                                    ...
                                    requestURI="axis_${pantalla}.do?paginar=true">
                                        <%@ include file="../include/displaytag.jsp"%>
                                            ...
                                            <axis:ocultar f="axisctr153" c="DESCRIPCION">
                                            ...
                                            <axis:ocultar f="axisctr153" c="ICAPITAL">
                                            ...
                                            <axis:visible f="axisctr153" c="IPRITAR">
                                            ...
                                            <axis:visible f="axisctr153" c="DETGARANT">
                                            ...
                                            <axis:visible f="axisctr153" c="PREGGARANT">
                                            ...
                                            <axis:visible f="axisctr153" c="FRANGARANT">
            ...
            <tr>
                <axis:visible f="axisctr153" c="but_tarifar"> 
                    <td align="center">
                        <div class="separador">&nbsp;</div>
                        <input type="button" class="boton" id="but_tarifar" value="<axis:alt f="axisctr153" c="BT_TARIFAR" lit="101688"></axis:alt>" onclick="javascript:f_tarifar()" />
                    <td>
                </axis:visible>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <div class="titulo"><img src="images/flecha.gif"/><axis:alt f="axisctr153" c="DSP_DETGARANTIAS" lit="1000196" ></axis:alt></div>
                    <!-- DisplayTag Garantías -->
                    <c:if test="${! empty sessionScope.axisctr_estdetgaranseg}">
                        ...
                        <div class="displayspaceGrande">
                            <display:table name="${sessionScope.axisctr_estdetgaranseg}" id="axisctr_estdetgaranseg" export="false" class="dsptgtable" pagesize="-1" defaultsort="1" defaultorder="ascending" sort="list" cellpadding="0" cellspacing="0"
                                 requestURI="axis_axisctr153.do?paginar=true">
                                <%@ include file="../include/displaytag.jsp"%>
    ...
    <c:import url="../include/botonera_nt.jsp">
        <c:param name="f">axisctr153</c:param>
        <c:param name="__botones"><axis:visible f="axisctr153" c="BT_CANCELAR">cancelar</axis:visible><axis:visible f="axisctr153" c="BT_ANT">,anterior</axis:visible><axis:visible f="axisctr153" c="BT_SEG">,siguiente</axis:visible></c:param>
    </c:import>
</form>