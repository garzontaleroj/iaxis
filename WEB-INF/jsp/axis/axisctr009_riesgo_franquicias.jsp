...
%>
<axis:visible c="DSP_TOT_FRANQUICIAS" f="axisctr009">
	<c:if
			...
			<td class="campocaja">
				<div style="float: left;">
					<img id="DSP_FRANQUICIAS_parent" src="images/mes.gif"
						...
						style="cursor: pointer" /> <b><axis:alt f="axisctr009"
				...
				<div style="float: right;">
					...
					<!-- IAXIS-5423 CJMR 23/09/2019 <input type="button" class="boton" id="but_detfranq"
						value="<axis:alt f="axisctr009" c="BT_DETFRANQ" lit="9904192"></axis:alt>"
		...
		<tr id="DSP_FRANQUICIAS_children" style="display: none">
			<td class="campocaja"><c:if
					...
					<axis:visible c="DSP_FRANQUICIAS" f="axisctr009">
							...
							<tr id="DSP_FRANQUICIAS_children">
								<td class="campocaja">
									<div class="displayspace">
										<c:set var="title0">
											<axis:alt f="axisctr009" c="DESCRIPCION" lit="100588"></axis:alt>
										</c:set>
										<!-- INI IAXIS-4936 -->
										<c:set var="title6">
											<axis:alt f="axisctr009" c="IMPORT_MIN" lit="9904858"></axis:alt>
										</c:set>
										<c:set var="title7">
											<axis:alt f="axisctr009" c="TIPO_IMPORT" lit="9002015"></axis:alt>
										</c:set>
										<!-- FIN IAXIS-4936 -->
										<c:set var="title1">
											<axis:alt f="axisctr009" c="IIMPORT" lit="101159"></axis:alt>
										</c:set>
												...
												<axis:visible f="axisctr009" c="TNIVEL">
													<display:column title="${title1}" sortable="false"
														...
														<div class="dspText">
															<c:choose>
																<c:when
																	test="${!empty franquicias.OB_IAX_BONFRANSEG.IMPVALOR1 && franquicias.OB_IAX_BONFRANSEG.CVALOR1 == 1 && empty franquicias.OB_IAX_BONFRANSEG.CVALOR2  && empty franquicias.OB_IAX_BONFRANSEG.CIMPMIN && empty franquicias.OB_IAX_BONFRANSEG.CIMPMAX }">
																	<fmt:formatNumber
																		pattern="${__formatNumberPatterns[__defaultCMONINT]}"
																		value="${franquicias.OB_IAX_BONFRANSEG.IMPVALOR1}" />
																</c:when>
																<c:otherwise>
						                                                                   ${franquicias.OB_IAX_BONFRANSEG.TNIVEL}
						                                                                </c:otherwise>
															</c:choose>
														</div>
													</display:column>
										...
										<c:if test="${!empty OB_IAX_RIESGOS.franqlibres}">
					...
					<axis:visible c="DSP_FRANQTECNICAS" f="axisctr009">
						<table class="area" align="center">
							...
							<tr>
								<td class="campocaja"><img id="DSP_FRANQTECNICAS_parent"
									...
									style="cursor: pointer" /> <b><axis:alt
											c="LIT_FRANQTECNICAS" f="axisctr009" lit="9904198" /></b>
	...
	<c:if
			...
			<td class="campocaja">
				...
				<div style="float: right;">
					...
					<input type="button" class="boton" id="BT_DETBONUS"
						value="<axis:alt f="axisctr009" c="BT_DETBONUS" lit="1000113"></axis:alt>"
		...
		<tr id="DSP_BONUSMALUS_children" style="display: none">
			<td class="campocaja"><c:if
					test="${! empty OB_IAX_RIESGOS.bonusmalus ||! empty OB_IAX_RIESGOS.bonusmaluslibres}">
					<axis:visible c="DSP_BONUSMALUS" f="axisctr009">
						<table class="area" align="center">
							<div class="separador">&nbsp;</div>
							<tr>
								<td class="campocaja">
