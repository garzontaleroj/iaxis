  ...
  <script type="text/javascript">
        ...
        function f_onload() {
           ...
           revisarEstilos();
                ...
                <axis:visible f="axisadm047" c="VINCULADA">
                objDom.setVisibilidadPorId("VINCU", "hidden");
                objDom.setVisibilidadPorId("TVINCU", "hidden"); 
                </axis:visible>
                objDom.setVisibilidadPorId("CEMPRES", "visible"); 
                objDom.setVisibilidadPorId("TEMPRES", "visible");
                objDom.setVisibilidadPorId("CESTADO", "hidden");
                objDom.setVisibilidadPorId("TCESTADO", "hidden")
                objDom.setVisibilidadPorId("CESTREC", "hidden");;
                objDom.setVisibilidadPorId("TESTREC", "hidden");
                objDom.setVisibilidadPorId("TTIPREC", "hidden");
                objDom.setVisibilidadPorId("CTIPREC", "hidden");  
        ...
        function f_but_109006() {
           ...
           if (objValidador.validaEntrada()) { 
                ...
                var CESTREC = objDom.getValorPorId("CESTREC"); 
                var CTIPREC = objDom.getValorPorId("CTIPREC");                                                     
                
                objAjax.invokeAsyncCGI("axis_axisadm047.do",callbackAjaxGenerarResultado_map,"operation=ajax_generar_resultados_map&CMAP="+CMAP+"&CEMPRES="+CEMPRES+"&CESTREC="+CESTREC
                    +"&CAGENTE="+CAGENTE+"&CESTADO="+CESTADO+"&FDESDE="+FDESDE+"&FHASTA="+FHASTA+"&CTIPREC="+CTIPREC , this, objJsMessages.jslit_cargando);
            }
        }
        ...
        function f_cargar_productos(){
            ...
            objAjax.invokeAsyncCGI("axis_axisadm047.do", callbackAjaxCargarProductos, "operation=ajax_busqueda_productos&CRAMO=" + objDom.getValorComponente(document.miForm.CRAMO) + 
        ...
        function f_cargar_ramos(){
            ...
            objAjax.invokeAsyncCGI("axis_axisadm047.do", callbackAjaxCargarRamos, "operation=ajax_busqueda_ramos&CAGRPRO=" + objDom.getValorComponente(document.miForm.CAGRUPA) + 
        ...
        function f_ocultar(cmap){
            if (cmap == 344) {
                ...
                objDom.setVisibilidadPorId("CESTADO", "hidden"); 
                objDom.setVisibilidadPorId("TCESTADO", "hidden");                
                objDom.setVisibilidadPorId("TESTREC", "visible");
                objDom.setVisibilidadPorId("TTIPREC", "visible");
                objDom.setVisibilidadPorId("CESTREC", "visible");
                objDom.setVisibilidadPorId("AGENTE", "visible");   
                objDom.setVisibilidadPorId("TAGENTE", "visible");  
                objDom.setVisibilidadPorId("CTIPREC", "visible");  
...
<body  onload="f_onload()">
    ...
    <form name="miForm" action="" method="POST">         
        ...
        <c:import url="../include/titulo_nt.jsp">
            <c:param name="titulo"><b><fmt:message key="9002171"/></b></c:param>    
            <c:param name="formulario"> <b> <fmt:message key="9002171"/></b></c:param> 
            <c:param name="form">Axisadm047</c:param>
        </c:import>
        <c:import url="../include/modal_estandar.jsp">
                <c:param name="titulo"><fmt:message key="1000234" /></c:param>
                <c:param name="nid" value="axisctr014" />
                        ...
                        <tr>
                            <td >
                                ...
                                <table class="area" align="center">
                                    ...
                                    <tr>
                                        <td class="titulocaja">
                                            <b><fmt:message key="9002171" /></b>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="campocaja">
                                            <select name = "CLISTADO" id="CLISTADO"   size="1" onchange="f_ocultar(this.value)"
                                                class="campowidthselect campo campotexto_ob"  <axis:atr f="axisadm047" c="CLISTADO" a="modificable=true&isInputText=false"/> >
                                ...
                                <table class="area" align="center">
                                    ...
                                    <tr>
                                        <td class="titulocaja" id="TEMPRES">
                                            <b><fmt:message key="102071" /></b> <!--empresa-->
                                        </td>
                                        <td></td>
                                        <td class="titulocaja" id="TESTREC" >
                                            <b><fmt:message key="1000553"/></b><!--estado recibo-->
                                        </td>
                                        <td></td>
                                        <td class="titulocaja" id="TTIPREC">
                                            <b><fmt:message key="102302" /></b><!--tipo de recibo-->
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="campocaja">                                            
                                            <select name = "Empresas" id="CEMPRES" type = "Empresa"  size="1" onchange=""
                                                class="campowidthinput campo campotexto_ob"  <axis:atr f="axisadm047" c="CEMPRES" a="modificable=true&isInputText=true&obligatorio=true"/> >
                                                <option value = ""> - <fmt:message key="108341"/> - </option>
                                                <c:forEach var="empresas" items="${EMPRESAS}">
                                                    <option value = "${empresas.CEMPRES}"
                                                    <c:if test="${(!empty __formdata.EMPRESAS.CEMPRES)&& empresas.CEMPRES == __formdata.EMPRESAS.CEMPRES}"> selected </c:if>>
                                        ...
                                        <td></td>
                                        <td class="campocaja">
                                            <select name = "CESTREC" id ="CESTREC"   size="1" onchange="" class="campowidthselect campo campotexto">
                                                <option value = "<%= Integer.MIN_VALUE %>"> - <fmt:message key="108341"/> - </option>
                                                <c:forEach var="estrecs" items="${ESTRECS}">
                                        ...
                                        <td></td>                     
                                        <td class="campocaja">
                                            <select name = "CTIPREC" id ="CTIPREC"   size="1" onchange="" class="campowidthselect campo campotexto">
                                                <option value = "<%= Integer.MIN_VALUE %>"> - <fmt:message key="108341"/> - </option>
                                                <c:forEach var="tiprecs" items="${TIPRECS}">
                                    ...
                                    <tr>
                                        ...
                                        <td class="titulocaja">
                                            <div id="TAGENTE" >
                                            <b><axis:alt f="axisadm047" c="TCAGENTE" lit="100584"></axis:alt></b>
                                            </div>
                                           <axis:visible f="axisadm047" c="VINCULADA"> 
                                                <div id="TVINCU">
                                    ...
                                    <tr>
                                        ...
                                        <td class="campocaja">
                                            ...
                                            <div id="VINCU">
                                                ...
                                                class="campowidthselect campo campotexto"  <axis:atr f="axisadm047" c="CVINCU" a="modificable=true&isInputText=false"/> >
                                                <option value = ""> - <fmt:message key="108341"/> - </option>
                                                <option value="1"
                                    ...
                                    <tr>
                                        <td class="titulocaja" id="TCESTADO">
                                            <b><fmt:message key="100874"/> <fmt:message key="9001875"/></b>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="campocaja">
                                            <select name = "CESTADO" id="CESTADO"   size="1" onchange=""
                                                class="campowidthselect campo campotexto"  <axis:atr f="axisadm047" c="CESTADO" a="modificable=true&isInputText=false"/> >
                                                <option value = ""> - <fmt:message key="108341"/> - </option>
