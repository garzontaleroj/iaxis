...
<html>
    <head>
        <title><axis:alt f="axisctr207" c="TITOLAXISCRT207" lit="1000183"/></title>
        ...
        <script type="text/javascript" src="scripts/jsFecha.js"></script>  <!-- BUG 41143/229973 - 17/03/2016 - JAEG -->
        <c:import url="../../../scripts/axis/axisctr207.jsp">
               <c:param name="multiPantalla" value="false"/>
        </c:import>                    
    </head>
    <body onload="f_onload_axisctr207();revisarEstilos();">
        
      <%--  <c:import url="axisctr207_preguntas.jsp">
            <c:param name="multiPantalla" value="false"/>
        </c:import>--%>
        <c:import url="axisctr207_body.jsp">
            <c:param name="multiPantalla" value="false"/>
        </c:import>
