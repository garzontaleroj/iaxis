<%/* Revision:# JGDK9X8WK54sQpC79dHQWQ== # */%>
        ...
        <display:table name="${sessionScope.axismprxxx_lista}" id="miListaId" export="false" class="dsptgtable" pagesize="${mprlistasize}" requestURI="${tipo_pantalla}_${sessionScope.AXISMPRXXX}.do?paginar=true" sort="list" cellpadding="0" cellspacing="0">
            ...
            <c:choose>
                <c:when test="${miListaId.CTIPO==1}">
                       <input type="text" class="campo" name="val<c:out value="${XCUTILI}" />_1_<c:out value="${miListaId.CPARAM}" />" id="val<c:out value="${XCUTILI}" />_1_<c:out value="${miListaId.CPARAM}" />" value="<c:out value="${miListaId.TVALPAR}" />" style="width:250px" ondblclick="f_ondblclick(this)" onchange="f_onchange(this)" <c:out value="${soloLecturaInput}" />/>
                    <%--    </display:column>  --%>
                    </c:when>
               ...
               <%--     <display:column title="${title2}" sortable="false" headerClass="headwidth5 sortable"  media="html" autolink="false" style="width:40%" >    
                   --%>
                        <input type="text" formato="fecha" class="campo" name="val<c:out value="${XCUTILI}" />_3_<c:out value="${miListaId.CPARAM}" />" id="val<c:out value="${XCUTILI}" />_3_<c:out value="${miListaId.CPARAM}" />" size="15" value="<fmt:formatDate value="${miListaId.FVALPAR}" pattern="dd/MM/yyyy"/>" style="width:100px" xondblclick="f_ondblclick(this)" onchange="f_onchange(this)"   <c:out value="${soloLecturaInput}" /> /> <c:if test="!ret" ><a style="vertical-align:middle;" href="#"><img id="popup_val<c:out value="${XCUTILI}" />_3_<c:out value="${miListaId.CPARAM}" />" border="0" src="images/calendar.gif"/></a></c:if>
              ...
              <%--      <display:column title="${title2}"  sortable="false" headerClass="headwidth5 sortable"  media="html" autolink="false" style="width:40%">
                  --%>
                         ...
                         <c:if test="${!empty miListaId.NVALPAR}">
                        <select class="campo" style="width:250px" name="val<c:out value="${XCUTILI}" />_4_<c:out value="${miListaId.CPARAM}" />" id="val<c:out value="${XCUTILI}" />_4_<c:out value="${miListaId.CPARAM}" />" onchange="f_onchange(this)" mivalue="${miListaId.NVALPAR}"  <c:out value="${soloLecturaSelect}" />>
                            <option value=""></option>
                        </select>
                        </c:if>
                        <c:if test="${empty miListaId.NVALPAR}">
                             <select class="campo" style="width:250px" name="val<c:out value="${XCUTILI}" />_4_<c:out value="${miListaId.CPARAM}" />" id="val<c:out value="${XCUTILI}" />_4_<c:out value="${miListaId.CPARAM}" />" onchange="f_onchange(this)" mivalue="${miListaId.CVALPAR}"  <c:out value="${soloLecturaSelect}" />>
                            <option value=""></option>
                        </select>
                        </c:if>
