//Revision:# L4F+DP42A9pdA3clqMG/Ng== #
package axis.util;
...
public class Constantes {
	...
	// public static final String IDIOMA = "__idioma"; pregutar por el CIDIOMA en el
	// UsuarioBean de la session
	...
	public static final String PILA = "__pila";
	...
	public static final int CTIPGRU_GASTOS_ENDOSOS = 3; // IAXIS-3980 01/08/2019
	...
	public static final Map SHOW_AYUDA = new HashMap();
	public static final String SHOW_AYUDA_STR = "__showAyuda";
