...
public class Mensajes_nl_BE extends ListResourceBundle {
	private static Log logger = LogFactory.getLog(Mensajes_nl_BE.class);
	private static Properties literales = new Properties();
	static Object[][] contents = new Object[1][2];
	private static String localeName = Mensajes_nl_BE.class.getName().substring("axis.bundle.Mensajes_".length());
