...
public class Mensajes_es_CL extends ListResourceBundle {
	private static Log logger = LogFactory.getLog(Mensajes_es_CL.class);
	private static Properties literales = new Properties();
	static Object[][] contents = new Object[1][2];
	private static String localeName = Mensajes_es_CL.class.getName().substring("axis.bundle.Mensajes_".length());
