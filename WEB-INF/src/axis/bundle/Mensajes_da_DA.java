...
public class Mensajes_da_DA extends ListResourceBundle {
	private static Log logger = LogFactory.getLog(Mensajes_da_DA.class);
	private static Properties literales = new Properties();
	static Object[][] contents = new Object[1][2];
	private static String localeName = Mensajes_da_DA.class.getName().substring("axis.bundle.Mensajes_".length());
