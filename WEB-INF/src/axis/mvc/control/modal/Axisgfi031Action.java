...
import axis.service.modal.Axisgfi031Service;

public class Axisgfi031Action extends AbstractDispatchAction {
	Log logger = LogFactory.getLog(this.getClass());

	private Axisgfi031Service miServicio = new Axisgfi031Service();
