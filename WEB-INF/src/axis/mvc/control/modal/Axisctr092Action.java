...
import axis.service.modal.Axisctr092Service;

public class Axisctr092Action extends AbstractDispatchAction {
	Log logger = LogFactory.getLog(this.getClass());
	private Axisctr092Service miServicio = new Axisctr092Service();
