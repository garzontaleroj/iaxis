...
import axis.service.modal.Axisctr081Service;

/**
 * Axisctr081Action.java 06/03/2009
 */
public class Axisctr081Action extends AbstractDispatchAction {
	Log logger = LogFactory.getLog(this.getClass());
	private Axisctr081Service miServicio = new Axisctr081Service();
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		logger.debug("Axisctr081Action Init");
