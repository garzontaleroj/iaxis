...
import axis.service.axis.Axismpr005Service;

public class Axismpr005Action extends AbstractDispatchAction {
	static Log logger = LogFactory.getLog(Axismpr005Action.class);

	private Axismpr005Service miServicio = new Axismpr005Service();
