...
import axis.service.axis.Axismpr003Service;

public class Axismpr003Action extends AbstractDispatchAction {
	static Log logger = LogFactory.getLog(Axismpr003Action.class);

	private Axismpr003Service miServicio = new Axismpr003Service();
