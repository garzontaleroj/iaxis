...
import axis.service.axis.Axisctr211Service;
import axis.util.Constantes;

public class Axisctr211Action extends AbstractDispatchAction {

	Log logger = LogFactory.getLog(this.getClass());
	private Axisctr211Service miServicio = new Axisctr211Service();

	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws IOException, ServletException {
		log.info("Axisctr211Action Init");
	...
	public ActionForward form(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws IOException, ServletException {
		log.info("Axisctr211Action Form");
	...
	public ActionForward buscar(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws IOException, ServletException {
		log.info("Axisctr211Action Buscar");
	...
	public ActionForward volver_per(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		log.debug("Axisctr211Action volver_per");
		...
		try {
			...
			logger.error("Error en el servicio Axisctr211Action - m�todo volver", e);
		}
