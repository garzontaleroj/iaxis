...
import axis.service.axis.Axismpr008Service;

public class Axismpr008Action extends AbstractDispatchAction {
	static Log logger = LogFactory.getLog(Axismpr008Action.class);

	private Axismpr008Service miServicio = new Axismpr008Service();
