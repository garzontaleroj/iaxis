...
/**
 * Axisgfi018Service.java 20/08/2008
 * 
 * @author <a href="lcalvo@csi-ti.com">Luz Calvo</a>
 * @since Java 5.0
 */
public class Axisgfi019Service extends AxisBaseService {
	...
	public
		...
		logger.debug("Axisgfi018Service m_form");
		Map formdata = (Map) request.getAttribute(Constantes.FORMDATA);
		UsuarioBean usuario = (UsuarioBean) request.getSession().getAttribute(Constantes.USUARIO);
		try {

			String ITERACION = getCampoTextual(request, "NITERAC");
			logger.debug(formdata);

		} catch (Exception e) {
			logger.error("Error en el servicio Axisgfi018Service - m�todo m_form", e);
