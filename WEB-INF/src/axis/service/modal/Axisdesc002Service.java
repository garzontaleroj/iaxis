...
import axis.mvc.control.modal.Axisdesc002Action;
...
/**
 * Axisdesc002Service.java
 * 
 * @author <a href="mailto:amartinez@csi-ti.com">Alex Martinez</a>
 */
public class Axisdesc002Service extends AxisBaseService {
	...
	public void m_init(HttpServletRequest request, Axisdesc002Action thisAction) {
		logger.debug("Axisdesc002Service m_init");
		try {
			this.cargaListas(request);
		} catch (Exception e) {
			logger.error("Error en el servicio Axisdesc002Service - m�todo m_init", e);
			thisAction.guardarMensaje(request, "1000050", new Object[] { e.toString() }, Constantes.MENSAJE_ERROR);
		}
	}

	public void m_form(HttpServletRequest request, Axisdesc002Action thisAction) {
		logger.debug("Axisdesc002Service m_form");
		try {
			...
			logger.error("Error en el servicio Axisdesc002Service - m�todo m_form", e);
			thisAction.guardarMensaje(request, "1000050", new Object[] { e.toString() }, Constantes.MENSAJE_ERROR);
		} finally {
