...
public class AccesoPL {
	...
	/**
	 * Cualquier parametro que se desa ocultar en las trazas se ha de informar aqui.
	 * Son regexp's. Y Siempre en minusculas. ecg20130306
	 * http://mantis.srvcsi.com/view.php?id=26312#c139813
	 */
	 ...
	 * Los valores de algunos parametros (que coinciden con los regexps de
	 * ocultarINs) se expresan como "(hidden)"
	 * 
	 * @param callQuery
	 * @param sIN
	 * @param pIN
