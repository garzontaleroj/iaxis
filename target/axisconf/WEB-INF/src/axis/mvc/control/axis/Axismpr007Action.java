...
import axis.service.axis.Axismpr007Service;

public class Axismpr007Action extends AbstractDispatchAction {
	static Log logger = LogFactory.getLog(Axismpr007Action.class);

	private Axismpr007Service miServicio = new Axismpr007Service();
