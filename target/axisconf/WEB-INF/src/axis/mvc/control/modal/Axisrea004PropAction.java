...
import axis.service.modal.Axisrea004PropService;

public class Axisrea004PropAction extends AbstractDispatchAction {
	Log logger = LogFactory.getLog(this.getClass());
	private Axisrea004PropService miServicio = new Axisrea004PropService();
