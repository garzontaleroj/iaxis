...
import axis.service.modal.Axisper011Service;

public class Axisper011Action extends AbstractDispatchAction {
	Log logger = LogFactory.getLog(this.getClass());
	private Axisper011Service miServicio = new Axisper011Service();
	...
	public ActionForward init(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		this.topPila(request, "CMODO", "GENERAL");
	...
	public ActionForward grabarPersona(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		Axisper011Service.Persona persona = miServicio.initPersona(request, this);
		...
		// de retorno anterior
		if (miServicio.m_grabarContactoPersona(persona, request, this, isNew).intValue() == 0) {
			return mapping.findForward("form");
		}
