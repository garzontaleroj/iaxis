...
import axis.service.modal.Axisadm007Service;
 ...
 * @since Java 5.0
 */
public class Axisadm007Action extends AbstractDispatchAction {
	Log logger = LogFactory.getLog(this.getClass());
	private Axisadm007Service miServicio = new Axisadm007Service();
	...
	public ActionForward cargar_asientos(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws IOException, ServletException {
	...
	public ActionForward ajax_generar_resultados_map(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws IOException, ServletException {
		log.debug("Axisadm007Action ajax_generar_resultados_map");
