...
import axis.service.modal.Axisctr106Service;

public class Axisctr106Action extends AbstractDispatchAction {
	Log logger = LogFactory.getLog(this.getClass());
	private Axisctr106Service miServicio = new Axisctr106Service();
	...
	public ActionForward buscar(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		 ...
		 * (sin par�metros), nos cargamos en el form el atributo axisctr_listaAegura Por
		 * eso mejor hacer un mapping.findForward, para que no pase por el form y los
		 * productos que se cargan en form, ponerlos en session
		 */
		return mapping.findForward("form");
	}
