...
public class Mensajes_hr_HR extends ListResourceBundle {
	private static Log logger = LogFactory.getLog(Mensajes_hr_HR.class);
	private static Properties literales = new Properties();
	static Object[][] contents = new Object[1][2];
	private static String localeName = Mensajes_hr_HR.class.getName().substring("axis.bundle.Mensajes_".length());
