...
public class Mensajes_ca_ES extends ListResourceBundle {
	private static Log logger = LogFactory.getLog(Mensajes_ca_ES.class);
	private static Properties literales = new Properties();
	static Object[][] contents = new Object[1][2];
	private static String localeName = Mensajes_ca_ES.class.getName().substring("axis.bundle.Mensajes_".length());
