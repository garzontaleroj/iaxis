...
public class Mensajes_es_CO extends ListResourceBundle {
	private static Log logger = LogFactory.getLog(Mensajes_es_CO.class);
	private static Properties literales = new Properties();
	static Object[][] contents = new Object[1][2];
	private static String localeName = Mensajes_es_CO.class.getName().substring("axis.bundle.Mensajes_".length());
