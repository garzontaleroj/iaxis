...
public class Mensajes_pt_PT extends ListResourceBundle {
	private static Log logger = LogFactory.getLog(Mensajes_pt_PT.class);
	private static Properties literales = new Properties();
	static Object[][] contents = new Object[1][2];
	private static String localeName = Mensajes_pt_PT.class.getName().substring("axis.bundle.Mensajes_".length());
