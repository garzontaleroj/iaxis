...
public class Mensajes_en_UK extends ListResourceBundle {
	private static Log logger = LogFactory.getLog(Mensajes_en_UK.class);
	private static Properties literales = new Properties();
	static Object[][] contents = new Object[1][2];
	private static String localeName = Mensajes_en_UK.class.getName().substring("axis.bundle.Mensajes_".length());
