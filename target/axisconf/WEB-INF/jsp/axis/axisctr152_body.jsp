...
<c:choose>
    ...
    <c:otherwise>
        <c:set var="pantalla" value="axisctr152"/>
...
<c:if test="${param.multiPantalla != 'true'}">        
    ...
    <c:choose>
        ...
        <axis:alt f="axisctr152" c="SIMULACION" lit="108021" />
        </c:when>
        <c:when test="${sessionScope.MODO eq 'ALTA_POLIZA'}">
        <axis:alt f="axisctr152" c="ALTA_POLIZA" lit="101110" />
        </c:when>
        <c:otherwise>
        <axis:alt f="axisctr152" c="ELSE" lit="104752" />
        </c:otherwise>
    </c:choose>
    </c:set>
    <c:import url="../include/titulo_nt.jsp">
        ...
        <c:param name="formulario"><axis:alt f="axisctr152" c="TITULO" lit="${literalPantalla}" /></c:param>
    ...
    <c:if test="${__configform.axisctr152__CREVALI__visible == 'false'}">
    <input type="hidden" id="CREVALI" name="CREVALI" value="${sessionScope.axisctr_CREVALI}"/>
    </c:if>
    <c:if test="${__configform.axisctr152__PREVALI__visible == 'false'}">
    ...
    <c:import url="../include/modal_estandar.jsp">
        <c:param name="titulo"><axis:alt f="axisctr152" c="TITULO011" lit="1000185" /></c:param>
        <c:param name="nid" value="axisctr011" />
    </c:import>
    <c:import url="../include/modal_estandar.jsp">
        <c:param name="titulo"><axis:alt f="axisctr152" c="TITULO152" lit="1000186" /></c:param>
        <c:param name="nid" value="axisctr012" />
    </c:import>
    
    <c:import url="../include/modal_estandar.jsp">
        <c:param name="titulo"><axis:alt f="axisctr152" c="TITULO152_2" lit="1000573" /></c:param>
    ...
    <table class="mainTableDimensions base" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <c:if test="${param.multiPantalla != 'true'}">        
                    <table class="seccion">
                        <tr>
                            ...
                            <font color="#FF8400" ><b>
                                <axis:visible c="ETIQ_RISC" f="axisctr152">
                                    <axis:alt f="axisctr152" c="ETIQ_RISC" lit="100649"></axis:alt> 
                                </axis:visible>
                ...
                <div class="titulo"><img src="images/flecha.gif"/><axis:alt f="axisctr152" c="DSP_GARANTIAS" lit="1000183" ></axis:alt></div>
                <!--campos-->
                <table class="seccion">
                    <tr>
                        <td>
                            ...
                            <c:if test="${! empty sessionScope.axisctr_garantias}">
                                <c:set var="title0"><axis:alt f="axisctr152" c="GARTAB_COL0" lit="100559"/></c:set>
                                <c:set var="title1"><axis:alt f="axisctr152" c="GARTAB_COL1" lit="1000073"/></c:set>
                                <c:set var="title2"><axis:alt f="axisctr152" c="GARTAB_COL3" lit="102995"/></c:set>
                                <c:set var="title3"><axis:alt f="axisctr152" c="GARTAB_COL3" lit="140531"/></c:set>
                                ...
                                <div id="DSP_GARANTIAS" class="displayspaceOver" style="visibility:hidden;height:<c:out value="${num_gar*20+20+20}"/>px">&nbsp;</div>
                                    <div id="dt_garantias" class="displayspacewomax" style="height:<c:out value="${num_gar*20+20+20}"/>px;max-height: ${num_gar*20+20+20}px;">   
                                    ...
                                    requestURI="axis_${pantalla}.do?paginar=true">
                                        ...
                                        <%--<c:if test="${miListaIdGarantias.OB_IAX_GARANTIAS.EDITABLE == '0'}"> disabled </c:if> --%>
                                            ...
                                            <axis:ocultar f="axisctr152" c="DESCRIPCION">
                                            ...
                                            <axis:ocultar f="axisctr152" c="ICAPITAL">
                                                <display:column title="${title1}" sortable="false" sortProperty="OB_IAX_GARANTIAS.ICAPITAL" headerClass="sortable"  media="html" autolink="false" >
                                                    ...
                                                    <div class="dspIcons">
                                                        ...
                                                        <c:if test="${miListaIdGarantias.OB_IAX_GARANTIAS.CTIPCAP != '4'}">
                                                            ...
                                                            formato="decimal" title="<axis:alt f="axisctr152" c="CTIPCAP" lit="1000073"/> <axis:alt f="axisctr152" c="CTIPCAP2" lit="103455"/> ${miListaIdGarantias.OB_IAX_GARANTIAS.CGARANT}"/>
                                                        </c:if>
                                                    </div>
                                                </display:column>
                                            </axis:ocultar>
                                            <axis:visible f="axisctr152" c="IPRITAR">
                                                <display:column title="${title3}" sortable="false" sortProperty="OB_IAX_GARANTIAS.IPRITAR" headerClass="sortable"  media="html" autolink="false" >
                                                    ...
                                                    <div class="dspIcons">
                                                        ...
                                                        <c:if test="${miListaIdGarantias.OB_IAX_GARANTIAS.CTIPCAP == '5'}">
                                                            ...
                                                            formato="decimal" title="<axis:alt f="axisctr152" c="PRITAR" lit="1000073"/> <axis:alt f="axisctr152" c="PRITAR2" lit="103455"/> ${miListaIdGarantias.OB_IAX_GARANTIAS.CGARANT}"/>
                                                        </c:if>
                                                        <c:if test="${miListaIdGarantias.OB_IAX_GARANTIAS.CTIPCAP != '5'}">
                                                            <div class="dspNumber"><fmt:formatNumber pattern="${__formatNumberPatterns[__defaultCMONINT]}" value="${miListaIdGarantias.OB_IAX_GARANTIAS.IPRITAR}"/></div>
                                                        </c:if>
                                            ...
                                            <axis:visible f="axisctr152" c="DETGARANT">
                                            ...
                                            <axis:visible f="axisctr152" c="PREGGARANT">
                                            ...
                                            <axis:visible f="axisctr152" c="FRANGARANT">
            ...
            <tr>
                <axis:visible f="axisctr152" c="but_tarifar"> 
                    <td align="center">
                        <div class="separador">&nbsp;</div>
                        <input type="button" class="boton" id="but_tarifar" value="<axis:alt f="axisctr152" c="BT_TARIFAR" lit="101688"></axis:alt>" onclick="javascript:f_tarifar()" />
                    <td>
                </axis:visible>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <div class="titulo"><img src="images/flecha.gif"/><axis:alt f="axisctr152" c="DSP_DETGARANTIAS" lit="1000196" ></axis:alt></div>
                    <!-- DisplayTag Garantías -->
                    <c:if test="${! empty sessionScope.axisctr_estdetgaranseg}">
                        <c:set var="title0"><axis:alt f="axisctr152" c="DETGAR_COL00" lit="1000109"/></c:set>   <%-- Garantía  --%>
                        <c:set var="title1"><axis:alt f="axisctr152" c="DETGAR_COL01" lit="100561"/></c:set>   <%-- Garantía  --%>
                        <c:set var="title2"><axis:alt f="axisctr152" c="DETGAR_COL02" lit="1000073" /></c:set>
                        <c:set var="title3"><axis:alt f="axisctr152" c="DETGAR_COL03" lit="1000497" /></c:set>
                        <c:set var="title4"><axis:alt f="axisctr152" c="DETGAR_COL04" lit="9001755" /></c:set>
                        <c:set var="title5"><axis:alt f="axisctr152" c="DETGAR_COL05" lit="100883"/></c:set>
                        <c:set var="title6"><axis:alt f="axisctr152" c="DETGAR_COL06" lit="9000814"/></c:set>
                        <c:set var="title7"><axis:alt f="axisctr152" c="DETGAR_COL07" lit="9001984"/></c:set>
                        <div class="displayspaceGrande">
                            <display:table name="${sessionScope.axisctr_estdetgaranseg}" id="axisctr_estdetgaranseg" export="false" class="dsptgtable" pagesize="-1" defaultsort="1" defaultorder="ascending" sort="list" cellpadding="0" cellspacing="0"
                                 requestURI="axis_axisctr152.do?paginar=true">
                                <%@ include file="../include/displaytag.jsp"%>
        ...
        <div class="titulo"><img src="images/flecha.gif"/><axis:alt f="axisctr152" c="RESULTADOS" lit="1000345" /></div>
                    <!--campos-->
                    <table class="seccion">
                    <tr>
                        <td align="left">
                            <!-- DisplayTag detalle primas -->
                            <c:set var="title0"><axis:alt f="axisctr152" c="IPRIANU" lit="1000497"/></c:set>         <!-- IPRIANU / IPRITOT -->
                            <c:set var="title1"><axis:alt f="axisctr152" c="IIPS" lit="101515"/></c:set>            <!-- IIPS -->
                            <c:set var="title2"><axis:alt f="axisctr152" c="IDGS" lit="1000498"/></c:set>         <!-- IDGS -->
                            <c:set var="title3"><axis:alt f="axisctr152" c="ICONSOR" lit="103101"/></c:set>           <!-- ICONSOR -->                            
                            <c:set var="title4"><axis:alt f="axisctr152" c="IRECFRA" lit="1000341"/></c:set>            <!-- IRECFRA -->
                            <c:set var="title5"><axis:alt f="axisctr152" c="PRECARG" lit="101671"/></c:set>         <!-- PRECARG -->
                            <c:set var="title6"><axis:alt f="axisctr152" c="IEXTRAP" lit="101918"/></c:set>         <!-- IEXTRAP -->                                        
                            <c:set var="title7"><axis:alt f="axisctr152" c="PDTOCOM" lit="1000119"/></c:set>            <!-- PDTOCOM -->
                            <c:set var="title8"><axis:alt f="axisctr152" c="ITOTALR" lit="140531"/></c:set>    <!-- ITOTALR -->       
                            <c:set var="title9"><axis:alt f="axisctr152" c="IPRITAR" lit="1000496"/></c:set>         <!-- IPRITAR -->
                            <c:set var="title10"><axis:alt f="axisctr152" c="IPRIREB" lit="9000837"/></c:set>    <!-- IPRIREB -->
    ...
    <!-- Botonera -->
    <c:import url="../include/botonera_nt.jsp"><c:param name="f">axisctr152</c:param>
        <c:param name="f">axisctr152</c:param>
        <c:param name="__botones"><axis:visible f="axisctr152" c="BT_CANCELAR">cancelar</axis:visible><axis:visible f="axisctr152" c="BT_ANT">,anterior</axis:visible><axis:visible f="axisctr152" c="BT_SEG">,siguiente</axis:visible></c:param>
    </c:import>
</form>