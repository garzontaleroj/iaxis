        ...
        <script type="text/javascript">            
            function f_ondblclick(ths) {
                ...
                */
                ...
                f_abrir_axismpreditor(CUTILI, CTIPO, CPARAM, XVALPAR)
            }
            ...
            var ptho=null
            function f_abrir_axismpreditor (CUTILI,CTIPO, CPARAM, XVALPAR) {
...
<c:import url="../include/modal_estandar.jsp"><c:param name="nid_y_titulo">axismpr001|<fmt:message key="1000211" /></c:param></c:import>
...
<form name="miForm" action="" method="POST">
    ...
    <c:import url="../include/titulo_nt.jsp">
        <%--    <c:param name="modalidad">MODALIDAD</c:param>--%>
            <c:param name="titulo"><fmt:message key="1000210" /></c:param>
            <c:param name="formulario"><fmt:message key="1000210" /></c:param>
