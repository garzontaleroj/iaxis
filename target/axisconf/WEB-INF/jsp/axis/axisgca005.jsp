<%/* Revision:# WM/3MQ+ZLlD1uPPv0U/mdw== # */%>
...
<script language="Javascript" type="text/javascript">
	...
	function f_but_cancelar(){
		objUtiles.ejecutarFormulario("flujodetrabajo.do?forigen=axisgca005", "cancelar", document.miForm, "_self");
	}     
...
// 	FIN SGM IAXIS-4102 saldos a favor del cliente
	...
	function f_but_buscar(){		
		objUtiles.ejecutarFormulario("axis_axisgca005.do?action=BUSCAR","form", document.miForm, "_self",objJsMessages.jslit_cargando);
	} 
	...
	function f_but_aceptar(){
		objUtiles.ejecutarFormulario("axis_axisgca005.do?action=GUARDAR","form", document.miForm, "_self",objJsMessages.jslit_cargando);
	}
...
<body onload="f_onload()">
	...
	<c:import url="../include/titulo_nt.jsp">
		<c:param name="producto">
			<axis:alt f="axisadm001" c="TITULO" lit="9910403" />
		</c:param>
		<c:param name="formulario">
			<axis:alt f="axisadm001" c="TITULO" lit="9910403" />
		</c:param>
		<c:param name="form">axisgca005</c:param>
	</c:import>
	...
	<form name="miForm" id="miForm" action="" method="POST">
		...
		<table class="seccion" style="width: 90%;" align="center">
			<tr>
				<axis:ocultar dejarHueco="false" f="axisgca005" c="PERCORTE">
	<td><span class="bold"><axis:alt f="axisgca005" c="PERCORTE" lit="9910364"></axis:alt></span><br />
		...
		title="<axis:alt f='axisgca005' c='PERCORTE' lit='9910364'/>"
		alt="<axis:alt f='axisgca005' c='PERCORTE' lit='9910364'/>"
		<axis:atr f="axisgca005" c="PERCORTE" a="formato=fecha&modificable=true&obligatorio=true"/> />
		<a style="vertical-align: middle;"> <c:if test="${__formdata.CMODO != 'CONSULTA'}">
				<img id="icon_PERCORTE" alt="<axis:alt f="axisgca005" c="PERCORTE" lit="9910364"/>"
					title="<axis:alt f="axisgca005" c="PERCORTE" lit="9910364" />" src="images/calendar.gif" />
			</c:if>
	</a></td>
</axis:ocultar>

<!-- INI SGM IAXIS-4102 saldos a favor del cliente -->
				<axis:ocultar dejarHueco="false" f="axisgca005" c="CPENDIENTES">
				<td><span class="bold"><axis:alt f="axisgca005" c="CPENDIENTES" lit="9910360"></axis:alt></span><br />
						...
						<axis:atr f="axisgca005" c="CPENDIENTES"/>
				</axis:ocultar>
				<td></td>
				<td></td>
			</tr>
			<tr>
                            ...
                            <axis:ocultar f="axisgca005" c="CSUCURSAL" dejarHueco="false">
...
<axis:ocultar dejarHueco="false" f="axisgca005" c="NNUMIDEAGE">
					<td><span class="bold"><axis:alt f="axisgca005" c="NNUMIDEAGE" lit="9910198"></axis:alt></span><br />
						...
						<axis:atr f="axisgca005" c="NNUMIDEAGE" 
			a="formato=entero&modificable=true&obligatorio=false"/>
						alt="<axis:alt f="axisgca005" c="NNUMIDEAGE" lit="9909665" />"
						title="<axis:alt f="axisgca005" c="NNUMIDEAGE" lit="9909665" />" /><img border="0"
						src="images/find.gif" onclick="f_abrir_axisctr014()" style="cursor: pointer" /></td>
				</axis:ocultar>
				<axis:ocultar dejarHueco="false" f="axisgca005" c="TAGENTE">
					<td><span class="bold"><axis:alt f="axisgca005" c="TAGENTE" lit="9902363"></axis:alt></span><br />
						<input type="text" name="TAGENTE" id="TAGENTE" value="${__formdata.TAGENTE}"
						class="campowidthinput campo campotexto" style="width: 90%;"
						<axis:atr f="axisgca005" c="TAGENTE" a="modificable=true&obligatorio=false"/>
						alt="<axis:alt f="axisgca005" c="TAGENTE" lit="9909665" />"
						title="<axis:alt f="axisgca005" c="TAGENTE" lit="9909665" />" /></td>
				</axis:ocultar>
			...
			<tr>
				<axis:ocultar dejarHueco="false" f="axisgca005" c="NNUMIDECLI">
					<td><span class="bold"><axis:alt f="axisgca005" c="NNUMIDECLI" lit="9910042"></axis:alt></span><br />
						...
						<axis:atr f="axisgca005" c="NNUMIDECLI" 
			a="formato=entero&modificable=true&obligatorio=false"/>
						alt="<axis:alt f="axisgca005" c="NNUMIDECLI" lit="9910369" />"
						title="<axis:alt f="axisgca005" c="NNUMIDECLI" lit="9910369" />" /><img border="0"
						src="images/find.gif" onclick="f_abrir_persona()" style="cursor: pointer" /></td>
				</axis:ocultar>

				<axis:ocultar dejarHueco="false" f="axisgca005" c="TNOMCLI">
					<td><span class="bold"><axis:alt f="axisgca005" c="TNOMCLI" lit="9909970"></axis:alt></span><br />
						<input type="text" name="TNOMCLI" id="TNOMCLI" value="${__formdata.TNOMCLI}"
						class="campowidthinput campo campotexto" style="width: 90%;"
						<axis:atr f="axisgca005" c="TNOMCLI" a="modificable=true&obligatorio=false"/>
						alt="<axis:alt f="axisgca005" c="TNOMCLI" lit="9909970" />"
						title="<axis:alt f="axisgca005" c="TNOMCLI" lit="9909970" />" /></td>
				</axis:ocultar>
				<td></td>
				<td></td>
			</tr>
			<tr>
				<axis:ocultar dejarHueco="false" f="axisgca005" c="FDOCINI">
					<td><span class="bold"><axis:alt f="axisgca005" c="FDOCINI" lit="9910361"></axis:alt></span><br />
						...
						title="<axis:alt f='axisgca005' c='FDOCINI' lit='9910361'/>"
						alt="<axis:alt f='axisgca005' c='FDOCINI' lit='9910361'/>"
						<axis:atr f="axisgca005" c="FDOCINI" a="formato=fecha&modificable=true&obligatorio=true"/> />
						<a style="vertical-align: middle;"> <c:if test="${__formdata.CMODO != 'CONSULTA'}">
								<img id="icon_FDOCINI" alt="<axis:alt f="axisgca005" c="FDOCINI" lit="9910361"/>"
									title="<axis:alt f="axisgca005" c="FDOCINI" lit="9910361" />" src="images/calendar.gif" />
							</c:if>
					</a></td>
				</axis:ocultar>


				<axis:ocultar dejarHueco="false" f="axisgca005" c="FDOCFIN">
					<td><span class="bold"><axis:alt f="axisgca005" c="FDOCFIN" lit="9910362"></axis:alt></span><br />
						...
						title="<axis:alt f='axisgca005' c='FDOCFIN' lit='9910362'/>"
						alt="<axis:alt f='axisgca005' c='FDOCFIN' lit='9910362'/>"
						<axis:atr f="axisgca005" c="FDOCFIN" a="formato=fecha&modificable=true&obligatorio=true"/> />
						<a style="vertical-align: middle;"> <c:if test="${__formdata.CMODO != 'CONSULTA'}">
								<img id="icon_FDOCFIN" alt="<axis:alt f="axisgca005" c="FDOCFIN" lit="9910362"/>"
									title="<axis:alt f="axisgca005" c="FDOCFIN" lit="9910362" />" src="images/calendar.gif" />
							</c:if>
					</a></td>
				</axis:ocultar>

				<axis:ocultar dejarHueco="false" f="axisgca005" c="NDOCSAP">
					<td><span class="bold"><axis:alt f="axisgca005" c="NDOCSAP" lit="102999"></axis:alt></span><br />
						<input type="text" name="NDOCSAP" id="NDOCSAP" value="${__formdata.NDOCSAP}"
						class="campowidthinput campo campotexto" style="width: 90%;"
						<axis:atr f="axisgca005" c="NDOCSAP" a="modificable=true&obligatorio=false"/>
						alt="<axis:alt f="axisgca005" c="NDOCSAP" lit="102999" />"
						title="<axis:alt f="axisgca005" c="NDOCSAP" lit="102999" />" /></td>
				</axis:ocultar>
				<td></td>
			</tr>
			<tr>
				<axis:ocultar dejarHueco="false" f="axisgca005" c="FCONTINI">
					<td><span class="bold"><axis:alt f="axisgca005" c="FCONTINI" lit="9910363"></axis:alt></span><br />
						...
						title="<axis:alt f='axisgca005' c='FCONTINI' lit='9910363'/>"
						alt="<axis:alt f='axisgca005' c='FCONTINI' lit='9910363'/>"
						<axis:atr f="axisgca005" c="FCONTINI" a="formato=fecha&modificable=true&obligatorio=true"/> />
						<a style="vertical-align: middle;"> <c:if test="${__formdata.CMODO != 'CONSULTA'}">
								<img id="icon_FCONTINI" alt="<axis:alt f="axisgca005" c="FCONTINI" lit="9910363"/>"
									title="<axis:alt f="axisgca005" c="FCONTINI" lit="9910363" />" src="images/calendar.gif" />
							</c:if>
					</a></td>
				</axis:ocultar>


				<axis:ocultar dejarHueco="false" f="axisgca005" c="FCONTFIN">
					<td><span class="bold"><axis:alt f="axisgca005" c="FCONTFIN" lit="9910364"></axis:alt></span><br />
						...
						title="<axis:alt f='axisgca005' c='FCONTFIN' lit='9910364'/>"
						alt="<axis:alt f='axisgca005' c='FCONTFIN' lit='9910364'/>"
						<axis:atr f="axisgca005" c="FCONTFIN" a="formato=fecha&modificable=true&obligatorio=true"/> />
						<a style="vertical-align: middle;"> <c:if test="${__formdata.CMODO != 'CONSULTA'}">
								<img id="icon_FCONTFIN" alt="<axis:alt f="axisgca005" c="FCONTFIN" lit="9910364"/>"
									title="<axis:alt f="axisgca005" c="FCONTFIN" lit="9910364" />" src="images/calendar.gif" />
							</c:if>
					</a></td>
				</axis:ocultar>
				<td></td>
		...
		<table class="seccion" style="width: 90%;" align="center">
			...
			<tr>
				<td><c:set var="title0">
						<axis:alt f="axisgca005" c="CSUCURSAL_T" lit="9909330" />
					</c:set> <c:set var="title1">
						<axis:alt f="axisgca005" c="NNUMIDECLI_T" lit="89908040" />
					</c:set> <c:set var="title2">
						<axis:alt f="axisgca005" c="TNOMCLI_T" lit="89908041" />
					</c:set> <c:set var="title3">
						<axis:alt f="axisgca005" c="IDEBITO_T" lit="9910366" />
					</c:set> <c:set var="title4">
						<axis:alt f="axisgca005" c="ICREDITO_T" lit="9910367" />
					</c:set> <c:set var="title5">
						<axis:alt f="axisgca005" c="ISALDO_T" lit="104910" />
					</c:set> <c:set var="title6">
						<axis:alt f="axisgca005" c="ICODETALLE_T" lit="9906458" />
					</c:set>
					...
					<div class="seccion displayspaceGrande" style="width: 98%">
						<display:table name="${__formdata.LISTDEPU_SALDOFAVCLI}" id="ROW" export="false"
							...
							requestURI="axis_axisgca005.do?paginar=true" sort="list" cellpadding="0" cellspacing="0">
		...
		<table class="seccion" style="width: 90%;" align="center">
			...
			<tr>
				<td><c:set var="title0">
						<axis:alt f="axisgca005" c="CSUCURSAL_D" lit="9909330" />
					</c:set> <c:set var="title1">
						<axis:alt f="axisgca005" c="FDOC_D" lit="9903313" />
					</c:set> <c:set var="title2">
						<axis:alt f="axisgca005" c="NDOCSAP_D" lit="102999" />
					</c:set> <c:set var="title3">
						<axis:alt f="axisgca005" c="NNUMIDEAGE_D" lit="9910198" />
					</c:set> <c:set var="title4">
						<axis:alt f="axisgca005" c="TNOMAGE_D" lit="9902363" />
					</c:set> <c:set var="title5">
						<axis:alt f="axisgca005" c="NNUMIDECLI_D" lit="9910369" />
					</c:set> <c:set var="title6">
						<axis:alt f="axisgca005" c="TNOMCLI_D" lit="9909667" />
					</c:set> <c:set var="title7">
						<axis:alt f="axisgca005" c="FCONTAB_D" lit="1000575" />
					</c:set> <c:set var="title8">
						<axis:alt f="axisgca005" c="IDEBITO_D" lit="9910366" />
					</c:set> <c:set var="title9">
						<axis:alt f="axisgca005" c="ICREDITO_D" lit="9910371" />
					</c:set> <c:set var="title10">
						<axis:alt f="axisgca005" c="ISALDO_D" lit="104910" />
					</c:set> <c:set var="title11">
						<axis:alt f="axisgca005" c="TINCONSISTENCIA_D" lit="9910372" />
					</c:set> <c:set var="title12">
						<axis:alt f="axisgca005" c="CGESTION_D" lit="9910374" />					
 ...
 %><input type="hidden" name="CUENTA" id="CUENTA"
					...
					<div class="seccion displayspaceGrande" style="width: 98%">
						<display:table name="${__formdata.DETLISTDEPU_SALDOFAVCLI}" id="ROW" export="false"
							...
							<display:column title="${title12}" sortProperty="CGESTION_D" sortable="true"
								headerClass="sortable" media="html" autolink="false">
								<div class="dspIcons">
		...
		<c:import url="../include/botonera_nt.jsp">
			<c:param name="f">axisgca005</c:param>
			<c:param name="f">axisgca005</c:param>
			<c:param name="f">axisgca005</c:param>
