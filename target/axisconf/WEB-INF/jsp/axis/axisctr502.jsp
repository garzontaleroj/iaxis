...
<html>
<head>
    <title> <axis:alt f="axisctr502" c="LIT_TITULO" lit="9903339"/></title> 
  ...
  <script type="text/javascript">
        ...
        function f_onload() {
           ...
           <% if (request.getSession().getAttribute("abremodal") != null) { %>
               ...
               //objUtiles.abrirModal("axisctr502export","src","axisctr502export.jsp",300,80);   
               objUtiles.abrirModal("axisctr502export","src","modal_axisexporter.do?operation=axisctr502export",300,80);              
        ...
        function f_but_109006() {
           ...
           if (objValidador.validaEntrada()) {              
                objUtiles.ejecutarFormulario("axis_axisctr502.do", "consultar",document.miForm, "_self", objJsMessages.jslit_cargando);
                                }
        }
...
<body  onload="f_onload()">    
    ...
    <c:import url="../include/modal_estandar.jsp">
        <c:param name="nid_y_titulo">axisimprimir|<axis:alt f="axisctr502" c="LIT_FORM" lit="1000205"/>|true</c:param>
    </c:import>    
    
    <form name="miForm" action="" method="POST">         
    
        <c:import url="../include/titulo_nt.jsp">
            <c:param name="titulo"><b><axis:alt f="axisctr502" c="LIT_TITULO" lit="9903339"/></b></c:param>    
            <c:param name="formulario"> <b> <axis:alt f="axisctr502" c="LIT_TITULO" lit="9903339"/></b></c:param> 
            <c:param name="form">axisctr502</c:param>
        </c:import>
        ...
        <tr>
                                    ...
                                    <td class="titulocaja" id="LFDESDE">                                    
                                            <b><axis:alt f="axisctr502" c="LIT_LFDESDE" lit="9000526"/></b> <!--DATA INICI-->
                                        </td>
                                        <td class="titulocaja" id="LFHASTA">
                                            <b><axis:alt f="axisctr502" c="LIT_FHASTA" lit="9000527"/></b> <!--DATA FI-->
                                        </td>                                       
                                        </tr>
            <tr> 
                <td class="campocaja" >
                    ...
                    <img alt="<axis:alt f="axisctr502" c="LIT_FDESDE" lit="108341"/>" title="<axis:alt f="axisctr502" c="LIT_LITFDESDE" lit="100883"/>" src="images/calendar.gif"/></a>
                </td>            
                <td class="campocaja">
                    ...
                    <img alt="<axis:alt f="axisctr502" c="LIT_FHASTA" lit="108341"/>" title="<axis:alt f="axisctr502" c="LIT_LITFHASTA" lit="100883"/>" src="images/calendar.gif"/></a>
                </td>
           </tr>   
         </table>
                

<%--<display:table name="${REC_LSTCARTERA}" id="miLista" export="true" class="dsptgtable" pagesize="-1" style="visibility:hidden;display:none"  requestURI="axisctr502export.jsp" sort="list" cellpadding="0" cellspacing="0">
    ...
    <c:import url="../include/modal_estandar.jsp">
    			  <c:param name="f">axisctr502export</c:param> 
            <c:param name="nid">axisctr502export</c:param>
