...
<%--
      NOMBRE:    axislist003.jsp
      Fecha: 04/01/2011
      PROPÓSITO (descripción pantalla): 
      Ejemplo : Listados que se lanzan directamente contra un generador de reports
...
//crear DSP_PARAMS_WRAPPER contenido
  ...
  if(REPORTE != null && REPORTE != "undefined"){
    ...
    <form name="miForm" action="" method="POST"  <% if (",ULEA".equals(request.getParameter("ACCION"))) { %> style="display:none;"<% } %>>         

        <c:import url="../include/titulo_nt.jsp">
            <c:param name="titulo"><b><axis:alt f="axislist003" c="TITULO_FORM" lit="9000745"/></b></c:param>    
            <c:param name="formulario"> <b><axis:alt f="axislist003" c="TITULO_FORM" lit="9000745"/></b></c:param> 
       ...
       <!-- <input type="hidden" id="CIDIOMA" name="CIDIOMA"  value="${__formdata.CIDIOMA}"/>-->
        ...
        <table class="mainTableDimensions base" align="center" cellpadding="0" cellspacing="0" style="height:30px">
            <tr> 
                <td> 
                            ...
                            <td >
                                ...
                                <table class="area"  align="center">
                                    ...
                                    <tr>
                                        <td colspan="4" >
                                            <div class="titulo">
                                                <img src="images/flecha.gif"/><b><axis:alt f="axislist003" c="TIT_LISTADOS" lit="1000178"/> </b>
                                            </div>
                                    ...
                                    <tr>
                                        <td class="titulocaja" id="tit_CEMPRES">
                                            <b label="label_CEMPRES"><axis:alt f="axislist003" c="CEMPRES" lit="101619" /></b> <!--empresa-->
                                        </td>
                                         <td class="titulocaja" id="tit_CAREA">
                                            <b label="label_CAREA"><axis:alt f="axislist003" c="CAREA" lit="9909317" /></b> <!--empresa-->
                                        </td>
                                        <td class="titulocaja">
                                            <b id="label_CLISTADO"><axis:alt f="axislist003" c="CLISTADO" lit="9000745"/></b> <!-- listado -->
                                        </td>
                                        <td class="titulocaja">
                                          <b id="label_CGENREC"><axis:alt f="axislist003" c="CGENREC" lit="" /></b> <!-- listado -->
                                       </td>
                                       <td class="titulocaja">
                                            <b id="label_CIDIOMA"><axis:alt f="axislist003" c="CIDIOMA" lit="100654"/></b> <!-- idioma report JR-->
                                        </td>
                                        <td class="titulocaja" id="tit_CEXPORT" colspan="2">
                                            <b label="label_CEXPORT"><axis:alt f="axislist003" c="CEXPORT" lit="9901613" /></b> <!--exportar como -->
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="campocaja">                                            
                                            <select name = "CEMPRES" id="CEMPRES" paramMap="true"   size="1" onchange="f_onchange(this)"
                                                class="campowidthinput campo campotexto"   title="<axis:alt f="axislist003" c="CEMPRES" lit="101619"/>"
                                                <axis:atr f="axislist003" c="CEMPRES" a="modificable=true&isInputText=true&obligatorio=true"/> >
                                                <option value = "<%= Integer.MIN_VALUE %>"> - <axis:alt f="axislist003" c="SNV_COMBO" lit="108341"/> - </option>
                                        ...
                                        <td class="campocaja">
                                            <select name="CAREA" id="CAREA" size="1" onchange="f_onchange(this)" 
                                                class="campowidthselect campo campotexto" title="<axis:alt f="axislist003" c="CAREA" lit="9000745"/>"
                                                <axis:atr f="axislist003" c="CAREA" a="modificable=true&obligatorio=true&isInputText=false"/> >
                                            </select>
                                        </td>
                                        <td class="campocaja">
                                            <select name="CLISTADO" id="CLISTADO" size="1" onchange="f_onchange(this)" 
                                                class="campowidthselect campo campotexto" title="<axis:alt f="axislist003" c="CLISTADO" lit="9000745"/>"
                                                <axis:atr f="axislist003" c="CLISTADO" a="modificable=true&obligatorio=true&isInputText=false"/> >
                                            </select>
                                        </td>
                                        <td class="campocaja">
                                            <select name="CGENREC" id="CGENREC" size="1" onchange="" style="display:none"
                                                class="campotexto" title="<axis:alt f="axislist003" c="CGENREC" lit=""/>"
                                                <axis:atr f="axislist003" c="CGENREC" a="modificable=false&obligatorio=true&isInputText=false"/> >
                                            </select>
                                       </td>
                                       <td class="campocaja">
                                            <select name="CIDIOMA" id="CIDIOMA" size="1" onchange="" 
                                                class="campowidthselect campo campotexto" title="<axis:alt f="axislist003" c="CIDIOMA" lit="100622"/>"
                                                <axis:atr f="axislist003" c="CIDIOMA" a="modificable=true&obligatorio=true&isInputText=false"/> >
                                            </select>
                                        </td> 
                                        <td class="campocaja">
                                            <select name="CEXPORT" id="CEXPORT" size="1" onchange="f_onchange(this)" 
                                                class="campowidthselect campo campotexto" title="<axis:alt f="axislist003" c="CEXPORT" lit="9901613"/>"
                                        ...
                                        <tr>
											  <axis:ocultar f="axislist006" c="CEMAIL">
													<td class="titulocaja">
														  <b id="label_CEMAIL"><axis:alt f="axislist006" c="CEMAIL" lit="9905728"/></b>
													</td>
											  </axis:ocultar>         
											  <axis:ocultar f="axislist006" c="CCONFIRACION">
													<td class="titulocaja">
														  <b id="label_CCONFIRMACION"><axis:alt f="axislist006" c="CCONFIRACION" lit="9905729"/></b>
													</td>
											  </axis:ocultar>                                                 
                                        </tr>   
                                        <tr>
											  <axis:ocultar f="axislist006" c="CEMAIL">
													<td class="campocaja">
														  <input type="text" maxlength="100" class="campo campotexto" value="${__formdata.CEMAIL}" name="CEMAIL" id="CEMAIL" <axis:atr f="axislist006" c="CEMAIL"  a="modificable=true&isInputText=true"/>/>
													</td>
											  </axis:ocultar>        
											  <axis:ocultar f="axislist006" c="CCONFIRMACION">
													<td class="campocaja">
														  <input type="text"  maxlength="100" class="campo campotexto" value="${__formdata.CCONFIRMACION}" name="CCONFIRMACION" id="CCONFIRMACION" <axis:atr f="axislist006" c="CCONFIRMACION"  a="modificable=true&isInputText=true"/>/>
													</td>
											  </axis:ocultar>                                                 
                                           </tr>                                          
                                    <tr>
                                        <td class="campocaja" style="text-align:left">
                                        <input type="button" class="boton" name="but_salir" value="<axis:alt f="axislist003" c="BUT_SALIR" lit="100000" />" onclick="f_but_salir()" />
                                        </td>
                                        <td class="campocaja" style="text-align:right" colspan="3">
                                        <input type="button" class="boton" name="but_ejecutar" id="but_ejecutar" value="<axis:alt f="axislist003" c="BUT_EJECUTAR" lit="9905618" />" onclick="f_but_ejecutar()" />
                                        <input type="button" class="boton" name="but_ejecutar_batch" id="but_ejecutar_batch" value="<axis:alt f="axislist003" c="BUT_BATCH" lit="9905619" />" onclick="f_but_ejecuar_batch()" />
                                        
                                        <input type="button" class="boton" name="but_ejecutar_ulea" id="but_ejecutar_ulea" value="<axis:alt f="axislist003" c="BUT_ULEA" lit="89907028" />" onclick="f_but_ejecuar_ulea()" />
                                        <input type="button" class="boton" name="but_CierreDeSiniestros" id="but_CierreDeSiniestros" value="<axis:alt f="axislist003" c="BUT_CIERRE_SIN" lit="109006" />" onclick="f_but_CierreDeSiniestros()" />
                                ...
                                <table class="area" id="DSP_PARAMS" align="center">
                                    ...
                                    <tr>
                                        <td colspan="2" id="TITULO_PARAMS">
                                            <div class="separador">&nbsp;</div>
                                            <div class="titulo">
                                                <img src="images/flecha.gif"/><b><axis:alt f="axislist003" c="TIT_PARAMS" lit="103694"/> </b>
                                            </div>
                                         </td>
                                    </tr>
                                    <!-- aqui se van a crear diamicamente los -->
                                </table>
                                <span id="DSP_PARAMS_WRAPPER"></span>
                                <table class="area" align="center" style="width:54%">
                                    ...
                                    <tr>
                                     <axis:visible f="axislist003" c="CHK_CGENREC">
                                        <td class="titulocaja" style="text-align:left" id="CHECKREC_LIT">
                                            <b><axis:alt f="axislist003" c="CHECKREC" lit="9908521"/></b>
                                        </td> 
                                     </axis:visible>
                                     <axis:visible f="axislist003" c="CHK_CGENREC">
                                        <td>
                                          <input type="checkbox"  name="CHECKREC" id="CHECKREC"  onclick="this.value = this.checked ? 1 : 0"/>
                                        </td>
                                     </axis:visible>
                                    </tr>
                                </table> 
