...
<html>
    <head>
        <title><fmt:message key="1000333"/></title>
        ...
        <script type="text/javascript">        
            ...
            function f_onload() {                
                var buscarOK = ${requestScope.buscarOK == true};
                if (buscarOK)
            ...
            function f_but_buscar() {
                if (objValidador.validaEntrada())
                    objUtiles.ejecutarFormulario ("modal_axisimp003.do", "aceptar", document.miForm, "_self", objJsMessages.jslit_cargando);
            }
            ...
            function f_recarga_combos(comboOrigen) {
                ...
                objAjax.invokeAsyncCGI("modal_axisimp003.do", callbackAjaxActualizarCombos, 
            ...
            function callbackCancelar() {
                parent.f_cerrar_modal("axisimp003");
            }
                    ...
                    if (!objAppMensajes.existenErroresEnAplicacion(doc)) {
                        switch (comboOrigen) {
                            case 'E':   rellenarCombo(doc, "CRAMO");
                                        rellenarCombo(doc, "CCONCEP"); // fall-through
                            case 'R':   rellenarCombo(doc, "SPRODUC"); // fall-through
                            case 'P':   rellenarCombo(doc, "CACTIVI"); // fall-through                                       
    ...
    <body onunload="try { f_clear_resources(document.body) } catch (e) {}" onload="f_onload()" onkeypress="if (event.keyCode==13)  { f_but_buscar() }">
        ...
        <form name="miForm" action="" method="POST">
            ...
            <c:import url="../include/titulo_nt.jsp">
                <c:param name="formulario"><fmt:message key="9000696"/></c:param> <%-- Búsqueda de impuestos --%>
                <c:param name="titulo"><fmt:message key="9000696"/></c:param>     <%-- Búsqueda de impuestos --%>
                <c:param name="form">axisimp003</c:param>
            </c:import>
                    ...
                    <td>
                        ...
                        <table class="seccion" align="center">
                            ...
                            <tr>
                                ...
                                <%-- Empresa --%>
                                <td class="campocaja">
                                    <select name="CEMPRES" id="CEMPRES" size="1" class="campo campotexto" style="width:90%" 
                        ...
                        <table class="seccion" align="center">
                            ...
                            <tr>
                                ...
                                <td class="campocaja">
                                    ...
                                    alt="<fmt:message key="9000717"/>" title="<fmt:message key="9000717"/>" formato="fecha"
                                    <axis:atr f="axisimp005" c="FINIVIG" a="formato=fecha"/><a style="vertical-align:middle;"><img
                        ...
                        <c:import url="../include/botonera_nt.jsp">
                            <c:param name="f">axisimp003</c:param>
