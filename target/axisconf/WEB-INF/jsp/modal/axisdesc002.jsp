...
<html>
  <head>
    ...
    <script language="Javascript" type="text/javascript">
       ...
       var CDESC = document.axisdesc002Form.CODIGO.value;
       var TDESC = document.axisdesc002Form.DESCRIPCION.value;
       var CESTADO = document.axisdesc002Form.ESTADO.value;
       var CTIPO = 1;
       var FINIVIG = document.axisdesc002Form.FINIVIG.value;
       var FFINVIG = document.axisdesc002Form.FFINVIG.value;
       ...
       if(!objUtiles.estaVacio(fechaini) && !objUtiles.estaVacio(fechafin) ){
            if(fechafin<=fechaini)
                alert('<axis:alt f="axisdesc002" c="VALFECHAS" lit="101922" />');  
            else
                parent.f_but_buscar(CDESC,TDESC,CESTADO,CTIPO,FINIVIG,FFINVIG);
    ...
    <body onload="f_onload()" class=" ">
        ...
        <form name="axisdesc002Form" action="" method="POST">
            <input type="hidden" name="operation" value="">

            <c:import url="../include/titulo_nt.jsp">
                <c:param name="formulario"><axis:alt f="axisdesc002" c="formulario" lit="9903495" /></c:param>
                <c:param name="producto"><axis:alt f="axisdesc002" c="producto" lit="9903495" /></c:param>
                <c:param name="form">Axisdesc002</c:param>
            </c:import>
            <!-- Area de campos  -->
                            ...
                            <td align="left" >
                                <table class="area" align="center">
                                    ...
                                    <tr>
                                        <!-- Codigo -->
                                        <td class="titulocaja">
                                            <b><axis:alt f="axisdesc002" c="CODIGO" lit="1000109" /></b>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="campocaja" >
                                    ...
                                    <tr>
                                        <!-- DESCRIPCION -->
                                        <td class="titulocaja" >
                                            <b><axis:alt f="axisdesc002" c="DESCRIPCION" lit="100588" /></b>
                                        </td>
                                        <!-- Estado -->
                                        <td class="titulocaja" >
                                            <b><axis:alt f="axisdesc002" c="ESTADO" lit="100587" /></b>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="campocaja"  >
                                        ...
                                        <td class="campocaja"  >
                                            <select name = "ESTADO" id="ESTADO"  style="width:100%;"
                                                ...
                                                <option value=""> - <axis:alt f="axisdesc002" c="BLANCO" lit="108341"/> - </option>
                                    ...
                                    <tr>                                       
                                        <td class="titulocaja" >
                                            <b><axis:alt f="axisdesc002" c="FINIVIG" lit="9000716" /></b><!-- Inicioa vigencia -->
                                        </td> 
                                        <td class="titulocaja" >
                                            <b><axis:alt f="axisdesc002" c="FFINVIG" lit="9000717" /></b><!-- Fin vigencia -->
                                        </td> 
                                    </tr>
                                    <tr>                                        
                                        <td class="campocaja" >
                                            ...
                                            <img alt="<axis:alt f="axisdesc002" c="FINIVIG1" lit="108341"/>" title="<axis:alt f="axisdesc002" c="FINIVIG2" lit="100883" />" src="images/calendar.gif"/></a>
                                        </td>
                                        <td class="campocaja" >
                                            ...
                                            <img alt="<axis:alt f="axisdesc002" c="FFINVIG1" lit="108341"/>" title="<axis:alt f="axisdesc002" c="FFINVIG2" lit="100883" />" src="images/calendar.gif"/></a>
                                        </td>
                                    </tr>
                                </table>    
                            </td>
            ...
            <c:import url="../include/botonera_nt.jsp"><c:param name="f">axisdesc002</c:param><c:param name="f">axisdesc002</c:param>
