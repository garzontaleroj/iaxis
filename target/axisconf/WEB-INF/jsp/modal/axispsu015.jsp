 ...
 <body onload="f_onload()">
        ...
        <form name="miForm" action="" method="POST">
            ...
            <c:import url="../include/titulo_nt.jsp">
                ...
                <c:param name="form">axispsu015</c:param>
            </c:import>
                                ...
                                <tr>
                                    <td align="left">
                                        <table class="area" align="center">
                                            ...
                                            <tr>
                                                <axis:visible f="axispsu003" c="TUSUMOV " >
                                                    <td class="titulocaja">
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                 <axis:visible f="axispsu015" c="FAUTREC" >
                                                    <td class="titulocaja">
                                                        <b id="label_FAUTREC"><axis:alt f="axispsu003" c="FAUTREC" lit="100562"/></b> <%-- % Observaciones --%>
                                                        &nbsp;&nbsp;
                                                    </td>
                                                </axis:visible>
                                               </tr>
                                                ...
                                                <axis:visible f="axispsu015" c="FAUTREC" >
                                                    <td class="campocaja">
                                                        ...
                                                        value="<fmt:formatDate value="${__formdata.FFECAUT}" pattern="dd/MM/yyyy" />" 
                                                        style="width:80%"
                                                 ...
                                                 <axis:visible f="axispsu015" c="CAUTREC" >
                                                    <td class="titulocaja">
                                                        <b id="label_CAUTREC"><axis:alt f="axispsu003" c="CAUTREC" lit="100587"/></b> <%-- % Observaciones --%>
                                                        &nbsp;&nbsp;
                                                    </td>
                                                </axis:visible>
                                                </tr>
                                                 ...
                                                 <axis:visible f="axispsu015" c="CAUTREC" >
                                                 <td class="campocaja">
                                                     <select name = "CAUTREC" id="CAUTREC" onchange="f_cargar_propiedades_pantalla();" class="campowidthinput campo campotexto" style="width:95%" 
                                                          <axis:atr f="" c="CAUTREC" a="modificable=false&obligatorio=true&&isInputText=false"/>  size="1" title="<axis:alt f="axispsu015" c="CAUTREC" lit="9900977"/>">
                                            ...
                                            <tr>
                                                <axis:visible f="axispsu015" c="OBSERV" >
                                                    <td class="campocaja" colspan="4">
                                                     <textarea class="campowidthinput campo campotexto"  <axis:atr f="axispsu015" c="OBSERV" a="modificable=false&isInputText=false"/> style="width:100%;height: 100%" name="OBSERV" id="OBSERV">${__formdata.OBSERV}</textarea>
                                                    </td>
                                                </axis:visible>
