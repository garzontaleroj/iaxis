    ...
    <script language="Javascript" type="text/javascript">
        ...
        function f_but_buscar() {
         if (objValidador.validaEntrada())
           objUtiles.ejecutarFormulario("modal_axiscomi014.do", "buscar", document.miForm, "_self", objJsMessages.jslit_cargando);
        }
        function f_recargar(thiss) {
           if (thiss.value > 0) 
                if (objValidador.validaEntrada())
                    objUtiles.ejecutarFormulario("modal_axiscomi014.do", "form", document.miForm, "_self", objJsMessages.jslit_cargando);
        }
        
        function f_but_cancelar() {
            parent.f_cerrar_modal('axiscomi014');
        }
        ...
        //alert("en recarga de combos");
                ...
                objAjax.invokeAsyncCGI("modal_axiscomi014.do", callbackAjaxActualizarCombos, 
    ...
    <body onload="f_onload()" onkeypress="if (event.keyCode==13)  { f_but_buscar() }" >
        ...
        <form name="miForm" action="" method="POST">
            ...
            <c:import url="../include/titulo_nt.jsp">
                <c:param name="formulario"><axis:alt f="axiscomi014" c="LIT_FORMULARIO_1" lit="9904879" /></c:param>
                <c:param name="producto"><axis:alt f="axiscomi014" c="LIT_PANTALLA_1" lit="9904879" /></c:param>
                <c:param name="form">axiscomi014</c:param>
            </c:import>
            <c:import url="../include/modal_estandar.jsp">
                <c:param name="titulo"><axis:alt f="axiscomi014" c="TITULO_INC" lit="1000234"/></c:param>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table class="area" align="center">
                                        ...
                                        <tr>
                                           <axis:visible f="axiscomi014" c="CODCONV" >
                                                <td class="titulocaja">
                                                    <b><axis:alt f="axiscomi014" c="LIT_CCODIGO" lit="109155" /></b>
                                                </td>
                                             </axis:visible>	
                                           <axis:visible f="axiscomi014" c="TDESCONV" >
                                                <td class="titulocaja" colspan="3">
                                                    <b><axis:alt f="axiscomi014" c="LIT_TDESCRI" lit="100588" /></b>
                                                </td>
                                             </axis:visible>	
                                        </tr>
                                        <tr>
                                            <axis:visible f="axiscomi014" c="CODCONV">
                                                 <td class="campocaja"> 
                                                    ...
                                                    value ="${__formdata.CODCONV}" title="<axis:alt f="axiscomi014" c="ALT_CODCONV" lit="100885"/>" <axis:atr f="axiscomi014" c="CODCONV" a="modificable=true"/>/>
                                                </td>
                                            </axis:visible>
                                            <axis:visible f="axiscomi014" c="TDESCONV">
                                                 <td class="campocaja" colspan="3">
                                                    <input style="width:85%" type="text" class="campowidthinput campo campotexto" id="TDESCONV" name="TDESCONV" size="15"
                                                    value ="${__formdata.TDESCONV}" title="<axis:alt f="axiscomi014" c="ALT_TDESCONV" lit="100885"/>" <axis:atr f="axiscomi014" c="TDESCONV" a="modificable=true"/>/>
                                                 </td>
                                            </axis:visible>
                                        </tr>
                                        <tr>
                                           <axis:visible f="axiscomi014" c="FINIVIG" >
                                                <td class="titulocaja">
                                                    <b><axis:alt f="axiscomi014" c="LIT_FINIVIG" lit="9000716" /></b>
                                                </td>
                                             </axis:visible>	
                                           <axis:visible f="axiscomi014" c="FFINVIG" >
                                                <td class="titulocaja">
                                                    <b><axis:alt f="axiscomi014" c="LIT_FFINVIG" lit="9000717" /></b>
                                                </td>
                                             </axis:visible>	
                                        </tr>
                                        <tr>
                                            <axis:visible f="axiscomi014" c="FINIVIG">
                                                 <td class="campocaja">
                                                    ...
                                                    value ="<fmt:formatDate pattern="dd/MM/yyyy" value="${__formdata.FINIVIG}"/>" title="<axis:alt f="axiscomi014" c="x" lit="100885"/>" <axis:atr f="axiscomi014" c="FINIVIG" a="modificable=true&formato=fecha"/>/>
                                                    <a id="icon_FINIVIG" style="vertical-align:middle;" href="#">
                                                    <img border="0" alt="<axis:alt f="axiscomi014" c="ddd" lit="108341" />" title="<axis:alt f="axiscomi014" c="x1" lit="108341" />" src="images/calendar.gif"/>
                                                    </a>
                                                </td>
                                            </axis:visible>
                                            <axis:visible f="axiscomi014" c="FFINVIG">
                                                 <td class="campocaja">
                                                    ...
                                                    value ="<fmt:formatDate pattern="dd/MM/yyyy" value="${__formdata.FFINVIG}"/>" title="<axis:alt f="axiscomi014" c="x" lit="100885"/>" <axis:atr f="axiscomi014" c="FFINVIG" a="modificable=true&formato=fecha"/>/>
                                        ...
                                        <tr>
                                           <axis:visible f="axiscomi014" c="CRAMO" >
                                                <td class="titulocaja">
                                                    <b><axis:alt f="axiscomi014" c="LIT_CRAMO" lit="100784" /></b>
                                                </td>
                                             </axis:visible>	
                                           <axis:visible f="axiscomi014" c="SPRODUC" >
                                                <td class="titulocaja">
                                                    <b><axis:alt f="axiscomi014" c="LIT_SPRODUC" lit="100829" /></b>
                                                </td>
                                             </axis:visible>	                                 
                                        </tr>
                                        <tr>
                                        
                                    <axis:ocultar f="axiscomi014" c="CRAMO"> 
                                     <td class="campocaja">
                                                    <select name="CRAMO" id ="CRAMO" size="1" class="campo campotexto" style="width:90%" 
                                                    title="<axis:alt f="axiscomi014" c="LIT_TIT_CRAMO" lit="100784" />" onchange="f_recarga_combos('R');"
                                                    <axis:atr f="axiscomi014" c="CRAMO" a="isInputText=false"/>>
                                                        <option value="<%= Integer.MIN_VALUE %>"> - <axis:alt f="axiscomi014" c="LIT_SEL_CRAMO" lit="108341" /> - </option>
                                    ...
                                    <axis:ocultar f="axiscomi014" c="SPRODUC"> 
                                      <td class="campocaja" colspan="1">
                                                    <select name="SPRODUC" id ="SPRODUC" size="1" class="campo campotexto" style="width:95%"
                                                    title="<axis:alt f="axiscomi014" c="LIT_TIT_SPRODUC" lit="100829" />" <axis:atr f="axisadm054" c="SPRODUC" a="isInputText=false"/>>
                                                        <option value="<%= Integer.MIN_VALUE %>"> - <axis:alt f="axiscomi014" c="LIT_SEL_SPRODUC" lit="108341" /> - </option>
                                   ...
                                   <tr>
                                        <td class="titulocaja">
                                            <b><axis:alt f="axiscomi014" c="CAGENTE_TEXT" lit="9902363"/></b> <%-- Intermediario --%>
                                        </td>
                                        <td class="titulocaja" colspan="3">
                                            <b><axis:alt f="axiscomi014" c="NOMBRE_TEXT" lit="100588"/>&nbsp;<axis:alt f="axiscomi014" c="INTERMED_D" lit="9902363"/></b> <%-- Descripción Intermediario--%>
                                        </td>                  
                                    </tr>
                                    <tr>
                                        <td class="campocaja">                 
                                            <input type="text" name="CAGENTE_TEXT" id="CAGENTE_TEXT" style="width:65%;" value="${__formdata.CODI}" class="campowidthinput campo campotexto" 
                                                    <axis:atr f="axiscomi014" c="CAGENTE" a="modificable=true"/> onchange="f_actualizar_agente()" />
                                   ...
                                   <!-- ************************************************************************************************************************************ -->       
                                     <tr>
                                           <axis:ocultar f="axiscomi014" c="TNOMBNF" >
                                                <td id="td_TNOMBNF" class="titulocaja" colspan="4">
                                                    <b id="label_TNOMBNF"><axis:alt f="axiscomi014" c="TNOMBNF" lit="9902210" /></b>
                                                </td>
                                           </axis:ocultar>	
                                     </tr>
                                     <tr>
                  ...
                  <table class="seccion">
                            ...
                            <td align="left">
                                 <table border="0" class="area" align="left" style="width:100%;">
                                    ...
                                    <tr>
                                        <td>
                                            <c:set var="title0"><axis:alt f="axiscomi014" c="LISTA_CODIGO" lit="109155"/></c:set>
                                            <c:set var="title1"><axis:alt f="axiscomi014" c="LISTA_TDESCRI" lit="100588"/></c:set>
                                            <c:set var="title2"><axis:alt f="axiscomi014" c="LISTA_FINIVIG" lit="9000716"/></c:set>
                                            <c:set var="title3"><axis:alt f="axiscomi014" c="LISTA_FFINVIG" lit="9000717"/></c:set>
                                            <c:set var="title4"><axis:alt f="axiscomi014" c="EDITAR" lit="9901356"/></c:set>
                            
                                            <div class="seccion displayspaceGrande">
                                            <display:table name="${lista_convenios}" id="miListaId" export="false" class="dsptgtable" pagesize="8" defaultsort="1" defaultorder="ascending" requestURI="modal_axiscomi014.do?paginar=true"
                                            sort="list" cellpadding="0" cellspacing="0">
                                               ...
                                               <display:column title="${title0}" headerClass="sortable" sortProperty="CCODCONV"  media="html" autolink="false" >
                                                    <div class="dspText">${miListaId.IDCONVCOMESP}</div>
                                                </display:column>
                                                ...
                                                <display:column title="${title4}" headerClass="sortable" sortProperty="TNOMTOM"  media="html" autolink="false" >
                                                    <div class="dspIcons">
                                                        <img border="0"
                                                            alt='<axis:alt f="axiscomi014" c="MENS_ALT" lit="9001944"/>'
                                                            title1='<axis:alt f="axiscomi014" c="MENS_ALT" lit="9001944"/>'
                                                            src="images/lapiz.gif"
                                                            width="16px" height="16px"
                                                            style="cursor:pointer;"
                                                            onclick="f_editar_convenio('${miListaId.IDCONVCOMESP}')"/>
                                                    </div>
                                                </display:column>
                                             </display:table> 
                                            </div>	
            ...
            <div class="separador">&nbsp;</div>
            <c:import url="../include/botonera_nt.jsp"><c:param name="f">axiscomi014</c:param><c:param name="f">axiscomi014</c:param>
                <c:param name="f">axiscomi014</c:param>
