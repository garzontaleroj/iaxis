...
<html>
  <head>
    ...
    <script type="text/javascript">
        ...
        function f_but_salir() {
            parent.f_cerrar_modal('axisage021');                      
        }
        ...
        function f_but_aceptar(){
            if (objValidador.validaEntrada()) { 
                ...
                if( objUtiles.estaVacio(objDom.getValorPorId("IDDOCGEDOX"))) 
                    ...
                    objUtiles.ejecutarFormulario("modal_axisage021.do", "actualizardoc", document.miForm021, "_self", objJsMessages.jslit_cargando);      
  ...
  <body onunload="try { f_clear_resources(document.body) } catch (e) {}" onload="f_onload()">
    ...
    <form name="miForm" enctype='multipart/form-data' action="Axisage021Servlet" method="POST" accept-charset='UTF-8'>         
        <c:import url="../include/titulo_nt.jsp">
            <c:param name="titulo"><axis:alt f="axisage021" c="TITULO" lit="1000431"/></c:param>
            <c:param name="formulario"><axis:alt f="axisage021" c="TITFORM" lit="1000614"/></c:param>
            <c:param name="form">axisage021</c:param>
        </c:import>
        ...
        <input type="hidden" id="TAMANO" name="TAMANO" value="${__formdata.TAMANO}"/>
        ...
        <table id="tabla1" class="mainModalDimensions base" align="center" cellpadding="0" cellspacing="3">
                ...
                <td>
                    ...
                    <table class="seccion">                                            
                        ...
                        <tr>
                            ...
                            <td class="titulocaja">
                                <b><axis:alt f="axisage021" c="FITXER" lit="1000574"/></b> <%-- FITXER --%>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td class="campocaja" colspan="3">   
                                <input type="file" size="70" class="campowidthinput campo campotexto"  name="TFILE" id="TFILE" title="<axis:alt f="axisage021" c="TFILE" lit="1000574"/>" obligatorio="true"/>                                
                                <div class="separador">&nbsp;</div>                                                        
                            </td>
                            </c:if>
                        </tr>
                        <tr>
                            ...
                            <td class="titulocaja">
                                <b><axis:alt f="axisage021" c="myTDESC" lit="100588"/></b>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td class="campocaja" colspan="3" >                             
                                ...
                                title="<axis:alt f="axisage021" c="myTDESC" lit="100588"/>" obligatorio="true" value="${__formdata.myTDESC}"
                                <c:if test="${!empty __formdata.IDDOCGEDOX}"><axis:atr f="axisage021" c="myTDESC" a="modificable=false&obligatorio=true"/></c:if>/>                                
                                <div class="separador">&nbsp;</div>                               
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="titulocaja">
                                <b><axis:alt f="axisage021" c="myIDCAT" lit="1000612"/></b>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td class="campocaja"  colspan="3">                             
                                <select name = "myIDCAT" id ="myIDCAT" size="1" obligatorio="true" title="<axis:alt f="axisage021" c="myIDCAT" lit="1000612"/>" 
                                    class="campowidthselect campo campotexto_ob" style="width:50%;"
                                    <c:if test="${!empty __formdata.IDDOCGEDOX}">disabled="disabled"</c:if>>&nbsp;
                                        <option value="null"> - <axis:alt f="axisage021" c="SNV_COMBO" lit="108341"/> - </option> 
                        ...
                        <tr>
                            ...
                            <td class="titulocaja">
                                <b><axis:alt f="axisage021" c="TOBSERVACIONES" lit="101162"/></b>
                            </td>    
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td colspan="3" style="width:100%;"  class="campocaja"> <!-- colspan="5" -->
                                 <axis:ocultar c="OBSERVACIONES" f="axisage021" dejarHueco="false">
                       ...
                       <tr>
                            ...
                            <td class="titulocaja">
                                <b><axis:alt f="axisage021" c="FCADUCIDAD" lit="9001356"/></b>
                            </td> 
                            <td class="titulocaja">
                                <b><axis:alt f="axisage021" c="FALTA" lit="105887"/></b>
                            </td> 
                        </tr>
                        <tr>
                            <td>
                            ...
                            <axis:ocultar c="FCADUCIDAD" f="axisage021" dejarHueco="false" >
                                 <td class="campocaja" >
                                    ...
                                    title= "<axis:alt f="axisage021" c="FCADUCIDAD" lit="9001356"/>"  <axis:atr f="axisage021" c="FCADUCIDAD" a="modificable=true&obligatorio=false&formato=fecha"/>  />
                                    <a style="vertical-align:middle;"><img id="popup_calendario_FCADUCIDAD" alt="<axis:alt f="axisage021" c="FCADUCIDAD" lit="9001356"/>"  src="images/calendar.gif" </a>
                                </td>
                            </axis:ocultar>
                            <axis:ocultar c="FALTA" f="axisage021" dejarHueco="false" >
                                 <td class="campocaja" >
                                    ...
                                    title= "<axis:alt f="axisage021" c="FALTA" lit="105887"/>"  
                                    <axis:atr f="axisage021" c="FALTA" a="modificable=false&obligatorio=false&formato=fecha"/> />
                                 </td>
                            </axis:ocultar>
                        </tr>
                    </table>
         ...
         <c:otherwise>
          <form name="miForm021" action="" method="POST">
           <c:import url="../include/titulo_nt.jsp">
            <c:param name="formulario"><axis:alt f="axisage021" c="TITFORM" lit="1000614"/></c:param>
            <c:param name="form">axisage021</c:param>
        </c:import>
                        ...
                        <tr>
                            ...
                            <td class="campocaja" colspan="3">   
                                <input type="text" size="70" class="campowidthinput campo campotexto"  name="TFILE" id="TFILE" value="${__formdata.TFILE}" 
                                        title="<axis:alt f="axisage021" c="TFILE" lit="1000574"/>"
                                        <axis:atr f="axisage021" c="TFILE" a="modificable=false&obligatorio=true"/>/>                                
                                <div class="separador">&nbsp;</div>                                                        
                            </td>
                            </c:if>
                        </tr>
        ...
        <c:import url="../include/botonera_nt.jsp"><c:param name="f">axisage021</c:param><c:param name="f">axisage021</c:param><c:param name="__botones">salir,aceptar</c:param></c:import>
